...
!(function (a, b) {
  ...
  function c() {
    return (
      (d.Matrix = "undefined" != typeof Float32Array ? Float32Array : Array),
      d.Matrix
    );
  }
  function b(a) {
  ...
  return (
            ...
            for (b in a)
              (c = h[b]),
                ...
                h !== d &&
                  (k &&
                  d &&
                  (e.Utils.isPlainObject(d) || (f = Array.isArray(d)))
                    ? (f
                        ? ((f = !1), (g = c && Array.isArray(c) ? c : []))
                        : (g = c && e.Utils.isPlainObject(c) ? c : {}),
                      (h[b] = e.Utils.extend(k, g, d)))
                    : void 0 !== d && (h[b] = d));
        return h;
      },
    }),
    ...
    c(),
    (d.mat3 = {}),
    (d.mat3.create = function () {
      var a = new d.Matrix(9);
      return (
        (a[0] = 1),
        (a[1] = 0),
        (a[2] = 0),
    ...
    (d.mat4 = {}),
    (d.mat4.create = function () {
      var a = new d.Matrix(16);
      return (
        (a[0] = 1),
        (a[1] = 0),
        (a[2] = 0),
    ...
    (d.mat3.multiply = function (a, b, c) {
      c || (c = a);
      var d = a[0],
        e = a[1],
        f = a[2],
    ...
    (d.mat3.clone = function (a) {
      var b = new d.Matrix(9);
      return (
        (b[0] = a[0]),
        (b[1] = a[1]),
        (b[2] = a[2]),
    ...
    (d.mat4.multiply = function (a, b, c) {
      c || (c = a);
      var d = a[0],
        e = a[1],
        f = a[2],
    ...
    (d.DisplayObject = function () {
      (this.last = this),
        ...
        (this.worldAlpha = 1),
        (this._interactive = !1),
        (this.worldTransform = d.mat3.create()),
        (this.localTransform = d.mat3.create()),
        (this.color = []),
        (this.dynamic = !0),
        (this._sr = 0),
        (this._cr = 1);
    ...
    (d.DisplayObject.prototype.setInteractive = function (a) {
      this.interactive = a;
    }),
    ...
    (d.DisplayObject.prototype.addFilter = function (a) {
      if (!this.filter) {
        this.filter = !0;
        var b = new d.FilterBlock(),
          c = new d.FilterBlock();
        (b.mask = a),
          (c.mask = a),
          (b.first = b.last = this),
        ...
        for (var i = this, j = this.last; i; )
          i.last == j && (i.last = c), (i = i.parent);
        (this.first = b),
          this.__renderGroup && this.__renderGroup.addFilterBlocks(b, c),
          (a.renderable = !1);
      }
    }),
    (d.DisplayObject.prototype.removeFilter = function () {
      if (this.filter) {
        this.filter = !1;
        var a = this.first,
          b = a._iNext,
        ...
        var d = this.last,
          b = d._iNext,
          c = d._iPrev;
        b && (b._iPrev = c), (c._iNext = b);
        for (
          var e = d._iPrev, f = this;
          f.last == d && ((f.last = e), (f = f.parent));
    ...
    (d.DisplayObject.prototype.updateTransform = function () {
      ...
      (a[2] = i),
        ...
        (this.vcount = d.visibleCount);
    }),
    (d.visibleCount = 0),
    (d.DisplayObjectContainer = function () {
      d.DisplayObject.call(this), (this.children = []);
    }),
    (d.DisplayObjectContainer.prototype = Object.create(
      d.DisplayObject.prototype
    )),
    ...
    (d.DisplayObjectContainer.prototype.swapChildren = function () {}),
    ...
    (d.blendModes = {}),
    (d.blendModes.NORMAL = 0),
    (d.blendModes.SCREEN = 1),
    (d.Sprite = function (a) {
    ...
    (d.Sprite.fromImage = function (a) {
      var b = d.Texture.fromImage(a);
      return new d.Sprite(b);
    }),
    (d.Stage = function (a, b) {
      d.DisplayObjectContainer.call(this),
        (this.worldTransform = d.mat3.create()),
        (this.interactive = b),
    ...
    (d.Stage.prototype.updateTransform = function () {
      (this.worldAlpha = 1), (this.vcount = d.visibleCount);
      for (var a = 0, b = this.children.length; b > a; a++)
        this.children[a].updateTransform();
    ...
    (d.Stage.prototype.setBackgroundColor = function (a) {
      (this.backgroundColor = a || 0),
        (this.backgroundColorSplit = b(this.backgroundColor));
    ...
    (d.CustomRenderable = function () {
      d.DisplayObject.call(this);
    }),
    (d.CustomRenderable.prototype = Object.create(d.DisplayObject.prototype)),
    (d.CustomRenderable.prototype.constructor = d.CustomRenderable),
    (d.CustomRenderable.prototype.renderCanvas = function () {}),
    (d.CustomRenderable.prototype.initWebGL = function () {}),
    (d.CustomRenderable.prototype.renderWebGL = function () {}),
    (d.Strip = function (a, b, c) {
      d.DisplayObjectContainer.call(this),
        (this.texture = a),
        (this.blendMode = d.blendModes.NORMAL);
      try {
    ...
    (d.Strip.prototype = Object.create(d.DisplayObjectContainer.prototype)),
    (d.Strip.prototype.constructor = d.Strip),
    (d.Strip.prototype.setTexture = function (a) {
      (this.texture = a),
    ...
    (d.Rope.prototype = Object.create(d.Strip.prototype)),
    (d.Rope.prototype.constructor = d.Rope),
    (d.Rope.prototype.refresh = function () {
      var a = this.points;
      if (!(a.length < 1)) {
        var b = this.uvs,
          c = this.indices,
    ...
    (d.TilingSprite.prototype = Object.create(
      d.DisplayObjectContainer.prototype
    )),
    (d.TilingSprite.prototype.constructor = d.TilingSprite),
    ...
    (d.Graphics.prototype.drawElipse = function (a, b, c, e) {
      0 == this.currentPath.points.length && this.graphicsData.pop(),
        (this.currentPath = {
          lineWidth: this.lineWidth,
          lineColor: this.lineColor,
    ...
    (d.CanvasGraphics.renderGraphics = function (a, b) {
      for (var c = a.worldAlpha, e = 0; e < a.graphicsData.length; e++) {
        ...
        if (
          ...
          g[0] == g[g.length - 2] && g[1] == g[g.length - 1] && b.closePath(),
            f.fill &&
              ((b.globalAlpha = f.fillAlpha * c),
              (b.fillStyle = color =
                "#" + ("00000" + (0 | f.fillColor).toString(16)).substr(-6)),
              b.fill()),
            f.lineWidth && ((b.globalAlpha = f.lineAlpha * c), b.stroke());
    ...
    (d.CanvasRenderer = function (a, b, c, d) {
      (this.transparent = d),
        (this.width = a || 800),
        (this.height = b || 600),
    ...
    (d.CanvasRenderer.prototype.render = function (a) {
      (d.texturesToUpdate = []),
        (d.texturesToDestroy = []),
        d.visibleCount++,
        a.updateTransform(),
        ...
        d.Texture.frameUpdates.length > 0 && (d.Texture.frameUpdates = []);
    }),
    ...
    (d.CanvasRenderer.prototype.renderDisplayObject = function (a) {
      var b,
        c = this.context;
      ...
      do
        if (((b = a.worldTransform), a.visible))
          if (a.renderable) {
            ...
            } else if (a instanceof d.Strip)
              c.setTransform(b[0], b[3], b[1], b[4], b[2], b[5]),
                this.renderStrip(a);
            else if (a instanceof d.TilingSprite)
              c.setTransform(b[0], b[3], b[1], b[4], b[2], b[5]),
                this.renderTilingSprite(a);
            else if (a instanceof d.CustomRenderable) a.renderCanvas(this);
            else if (a instanceof d.Graphics)
              c.setTransform(b[0], b[3], b[1], b[4], b[2], b[5]),
                d.CanvasGraphics.renderGraphics(a, c);
            else if (a instanceof d.FilterBlock)
              if (a.open) {
                c.save();
                var g = a.mask.alpha,
                  h = a.mask.worldTransform;
                c.setTransform(h[0], h[3], h[1], h[4], h[2], h[5]),
                  (a.mask.worldAlpha = 0.5),
                  (c.worldAlpha = 0),
                  d.CanvasGraphics.renderGraphicsMask(a.mask, c),
                  c.clip(),
                  (a.mask.worldAlpha = g);
              } else c.restore();
            a = a._iNext;
    ...
    (d.CanvasRenderer.prototype.renderTilingSprite = function (a) {
      var b = this.context;
    ...
    (d._batchs = []),
    (d._getBatch = function (a) {
      return 0 == d._batchs.length ? new d.WebGLBatch(a) : d._batchs.pop();
    }),
    (d._returnBatch = function (a) {
      a.clean(), d._batchs.push(a);
    }),
    (d._restoreBatchs = function (a) {
      for (var b = 0; b < d._batchs.length; b++)
        d._batchs[b].restoreLostContext(a);
    }),
    (d.WebGLBatch = function (a) {
      (this.gl = a),
        (this.size = 0),
    ...
    (d.WebGLBatch.prototype.constructor = d.WebGLBatch),
    (d.WebGLBatch.prototype.clean = function () {
      (this.verticies = []),
        (this.uvs = []),
        (this.indices = []),
        (this.colors = []),
    ...
    (d.WebGLBatch.prototype.restoreLostContext = function (a) {
      (this.gl = a),
        (this.vertexBuffer = a.createBuffer()),
        (this.indexBuffer = a.createBuffer()),
        (this.uvBuffer = a.createBuffer()),
    ...
    (d.WebGLBatch.prototype.init = function (a) {
      (a.batch = this),
        (this.dirty = !0),
    ...
    (d.WebGLBatch.prototype.insertBefore = function (a, b) {
    ...
    (d.WebGLBatch.prototype.insertAfter = function (a, b) {
      this.size++, (a.batch = this), (this.dirty = !0);
      var c = b.__next;
      (b.__next = a),
        (a.__prev = b),
    ...
    (d.WebGLBatch.prototype.remove = function (a) {
      return (
        this.size--,
        0 == this.size
    ...
    (d.WebGLBatch.prototype.split = function (a) {
      this.dirty = !0;
      var b = new d.WebGLBatch(this.gl);
      b.init(a),
    ...
    (d.WebGLBatch.prototype.merge = function (a) {
      (this.dirty = !0),
    ...
    (d.WebGLBatch.prototype.growBatch = function () {
      var a = this.gl;
    ...
    (d.WebGLBatch.prototype.refresh = function () {
    ...
    (d.WebGLBatch.prototype.update = function () {
      this.gl;
      for (
        var a,
          b,
    ...
    (d.WebGLBatch.prototype.render = function (a, b) {
      if (
        ((a = a || 0),
        ...
        c.useProgram(e),
          ...
          this.dirtyUVS &&
            ((this.dirtyUVS = !1),
            c.bufferSubData(c.ARRAY_BUFFER, 0, this.uvs)),
          c.vertexAttribPointer(e.textureCoordAttribute, 2, c.FLOAT, !1, 0, 0),
          c.activeTexture(c.TEXTURE0),
          c.bindTexture(c.TEXTURE_2D, this.texture._glTexture),
          c.bindBuffer(c.ARRAY_BUFFER, this.colorBuffer),
          this.dirtyColors &&
            ((this.dirtyColors = !1),
            c.bufferSubData(c.ARRAY_BUFFER, 0, this.colors)),
          c.vertexAttribPointer(e.colorAttribute, 1, c.FLOAT, !1, 0, 0),
          c.bindBuffer(c.ELEMENT_ARRAY_BUFFER, this.indexBuffer);
        var f = b - a;
        c.drawElements(c.TRIANGLES, 6 * f, c.UNSIGNED_SHORT, 6 * 2 * a);
      }
    }),
      ...
      a._webGL ||
        ...
        a.dirty &&
          ...
          a.clearDirty &&
            ...
            (a._webGL.points = []),
            (a._webGL.indices = [])),
          d.WebGLGraphics.updateGraphics(a)),
        d.activatePrimitiveShader();
      var e = d.mat3.clone(a.worldTransform);
      d.mat3.transpose(e),
        c.blendFunc(c.ONE, c.ONE_MINUS_SRC_ALPHA),
        c.uniformMatrix3fv(d.primitiveProgram.translationMatrix, !1, e),
        c.uniform2f(d.primitiveProgram.projectionVector, b.x, b.y),
        c.uniform1f(d.primitiveProgram.alpha, a.worldAlpha),
        c.bindBuffer(c.ARRAY_BUFFER, a._webGL.buffer),
        c.vertexAttribPointer(
          d.shaderProgram.vertexPositionAttribute,
          2,
          c.FLOAT,
          !1,
          0,
        ...
        c.vertexAttribPointer(
          d.primitiveProgram.colorAttribute,
          4,
          c.FLOAT,
          !1,
          24,
        ...
        d.activateDefaultShader();
    }),
    (d.WebGLGraphics.updateGraphics = function (a) {
      for (var b = a._webGL.lastIndex; b < a.graphicsData.length; b++) {
        var c = a.graphicsData[b];
        c.type == d.Graphics.POLY
          ? (c.fill &&
              c.points.length > 3 &&
              d.WebGLGraphics.buildPoly(c, a._webGL),
            c.lineWidth > 0 && d.WebGLGraphics.buildLine(c, a._webGL))
          : c.type == d.Graphics.RECT
          ? d.WebGLGraphics.buildRectangle(c, a._webGL)
          : (c.type == d.Graphics.CIRC || c.type == d.Graphics.ELIP) &&
            d.WebGLGraphics.buildCircle(c, a._webGL);
      }
    ...
    (d.WebGLGraphics.buildRectangle = function (a, c) {
      var e = a.points,
        f = e[0],
        g = e[1],
        h = e[2],
      ...
      a.lineWidth &&
        ((a.points = [f, g, f + h, g, f + h, g + i, f, g + i, f, g]),
        d.WebGLGraphics.buildLine(a, c));
    }),
    (d.WebGLGraphics.buildCircle = function (a, c) {
      var e = a.points,
        f = e[0],
        g = e[1],
        h = e[2],
      ...
      if (a.lineWidth) {
        a.points = [];
        for (var t = 0; j + 1 > t; t++)
          a.points.push(f + Math.sin(k * t) * h, g + Math.cos(k * t) * i);
        d.WebGLGraphics.buildLine(a, c);
      }
    }),
    (d.WebGLGraphics.buildLine = function (a, c) {
      var e = a.points;
      if (0 != e.length) {
        ...
        (j = e[2 * (G - 2)]),
          ...
          E.push(M, N, O, L),
          F.push(I);
        for (var P = 0; H > P; P++) F.push(I++);
        F.push(I - 1);
      }
    }),
    (d.WebGLGraphics.buildPoly = function (a, c) {
      var e = a.points;
      if (!(e.length < 6)) {
        for (
          var f = c.points,
    ...
    (d._defaultFrame = new d.Rectangle(0, 0, 1, 1)),
    d.gl,
    (d.WebGLRenderer = function (a, b, c, e, f) {
      (this.transparent = !!e),
        (this.width = a || 800),
        (this.height = b || 600),
        (this.view = c || document.createElement("canvas")),
      ...
      this.view.addEventListener(
        ...
        (this.batchs = []);
      try {
        d.gl = this.gl = this.view.getContext("experimental-webgl", {
      ...
      d.initPrimitiveShader(),
        d.initDefaultShader(),
        d.initDefaultStripShader(),
        d.activateDefaultShader();
      var i = this.gl;
      (d.WebGLRenderer.gl = i),
        (this.batch = new d.WebGLBatch(i)),
        i.disable(i.DEPTH_TEST),
        i.disable(i.CULL_FACE),
        i.enable(i.BLEND),
        i.colorMask(!0, !0, !0, this.transparent),
        (d.projection = new d.Point(400, 300)),
        this.resize(this.width, this.height),
        (this.contextLost = !1),
        (this.stageRenderGroup = new d.WebGLRenderGroup(this.gl));
    }),
    (d.WebGLRenderer.prototype.constructor = d.WebGLRenderer),
    (d.WebGLRenderer.getBatch = function () {
      return 0 == d._batchs.length
        ? new d.WebGLBatch(d.WebGLRenderer.gl)
        : d._batchs.pop();
    }),
    (d.WebGLRenderer.returnBatch = function (a) {
      a.clean(), d._batchs.push(a);
    }),
    (d.WebGLRenderer.prototype.render = function (a) {
      if (!this.contextLost) {
        this.__stage !== a &&
          ((this.__stage = a), this.stageRenderGroup.setRenderable(a)),
          d.WebGLRenderer.updateTextures(),
          d.visibleCount++,
          a.updateTransform();
        var b = this.gl;
        if (
          ...
          this.stageRenderGroup.render(d.projection),
          a.interactive &&
            (a._interactiveEventsAdded ||
              ((a._interactiveEventsAdded = !0),
              a.interactionManager.setTarget(this))),
          d.Texture.frameUpdates.length > 0)
        ) {
          for (var c = 0; c < d.Texture.frameUpdates.length; c++)
            d.Texture.frameUpdates[c].updateFrame = !1;
          d.Texture.frameUpdates = [];
        }
      }
    }),
    (d.WebGLRenderer.updateTextures = function () {
      for (var a = 0; a < d.texturesToUpdate.length; a++)
        d.WebGLRenderer.updateTexture(d.texturesToUpdate[a]);
      for (var a = 0; a < d.texturesToDestroy.length; a++)
        d.WebGLRenderer.destroyTexture(d.texturesToDestroy[a]);
      (d.texturesToUpdate = []), (d.texturesToDestroy = []);
    }),
    (d.WebGLRenderer.updateTexture = function (a) {
      var b = d.gl;
    ...
    (d.WebGLRenderer.prototype.resize = function (a, b) {
      (this.width = a),
        ...
        (d.projection.x = this.width / 2),
        (d.projection.y = this.height / 2);
    }),
    ...
    (d.WebGLRenderer.prototype.handleContextRestored = function () {
      (this.gl = this.view.getContext("experimental-webgl", { alpha: !0 })),
        this.initShaders();
      for (var a in d.TextureCache) {
        var b = d.TextureCache[a].baseTexture;
        (b._glTexture = null), d.WebGLRenderer.updateTexture(b);
      }
      for (var c = 0; c < this.batchs.length; c++)
        this.batchs[c].restoreLostContext(this.gl), (this.batchs[c].dirty = !0);
      d._restoreBatchs(this.gl), (this.contextLost = !1);
    }),
    (d.WebGLRenderGroup = function (a) {
      (this.gl = a),
        this.root,
    ...
    (d.WebGLRenderGroup.prototype.constructor = d.WebGLRenderGroup),
    (d.WebGLRenderGroup.prototype.setRenderable = function (a) {
      this.root && this.removeDisplayObjectAndChildren(this.root),
        (a.worldVisible = a.visible),
        (this.root = a),
        this.addDisplayObjectAndChildren(a);
    }),
    (d.WebGLRenderGroup.prototype.render = function (a) {
      d.WebGLRenderer.updateTextures();
      var b = this.gl;
      b.uniform2f(d.shaderProgram.projectionVector, a.x, a.y),
        b.blendFunc(b.ONE, b.ONE_MINUS_SRC_ALPHA);
      for (var c, e = 0; e < this.batchs.length; e++)
        if (((c = this.batchs[e]), c instanceof d.WebGLBatch))
          this.batchs[e].render();
        else {
          var f = c.vcount === d.visibleCount;
          c instanceof d.TilingSprite
            ? f && this.renderTilingSprite(c, a)
            : c instanceof d.Strip
            ? f && this.renderStrip(c, a)
            : c instanceof d.Graphics
            ? f && c.renderable && d.WebGLGraphics.renderGraphics(c, a)
            : c instanceof d.FilterBlock &&
              (c.open
                ? (b.enable(b.STENCIL_TEST),
                  b.colorMask(!1, !1, !1, !1),
                  b.stencilFunc(b.ALWAYS, 1, 255),
                  b.stencilOp(b.KEEP, b.KEEP, b.REPLACE),
                  d.WebGLGraphics.renderGraphics(c.mask, a),
                  b.colorMask(!0, !0, !0, !1),
    ...
    (d.WebGLRenderGroup.prototype.handleFilter = function () {}),
    (d.WebGLRenderGroup.prototype.renderSpecific = function (a, b) {
      d.WebGLRenderer.updateTextures();
      var c = this.gl;
      c.uniform2f(d.shaderProgram.projectionVector, b.x, b.y);
      for (
        var e, f, g, h, i = a.first;
        i._iNext && ((i = i._iNext), !i.renderable || !i.__renderGroup);

      );
      var j = i.batch;
      if (i instanceof d.Sprite) {
        j = i.batch;
        var k = j.head;
        if (k == i) e = 0;
        else for (e = 1; k.__next != i; ) e++, (k = k.__next);
      } else j = i;
      for (var l, m = a, n = a; n.children.length > 0; )
        (n = n.children[n.children.length - 1]), n.renderable && (m = n);
      if (m instanceof d.Sprite) {
        l = m.batch;
        var k = l.head;
        if (k == m) g = 0;
        else for (g = 1; k.__next != m; ) g++, (k = k.__next);
      } else l = m;
      if (j == l)
        return (
          j instanceof d.WebGLBatch
            ? j.render(e, g + 1)
            : this.renderSpecial(j, b),
          void 0
        );
      (f = this.batchs.indexOf(j)),
        (h = this.batchs.indexOf(l)),
        j instanceof d.WebGLBatch ? j.render(e) : this.renderSpecial(j, b);
      for (var o = f + 1; h > o; o++)
        (renderable = this.batchs[o]),
          renderable instanceof d.WebGLBatch
            ? this.batchs[o].render()
            : this.renderSpecial(renderable, b);
      l instanceof d.WebGLBatch ? l.render(0, g + 1) : this.renderSpecial(l, b);
    }),
    (d.WebGLRenderGroup.prototype.renderSpecial = function (a, b) {
      var c = a.vcount === d.visibleCount;
      if (a instanceof d.TilingSprite) c && this.renderTilingSprite(a, b);
      else if (a instanceof d.Strip) c && this.renderStrip(a, b);
      else if (a instanceof d.CustomRenderable) c && a.renderWebGL(this, b);
      else if (a instanceof d.Graphics)
        c && a.renderable && d.WebGLGraphics.renderGraphics(a, b);
      else if (a instanceof d.FilterBlock) {
        var e = d.gl;
        a.open
          ? (e.enable(e.STENCIL_TEST),
            ...
            d.WebGLGraphics.renderGraphics(a.mask, b),
            e.colorMask(!0, !0, !0, !0),
    ...
    (d.WebGLRenderGroup.prototype.updateTexture = function (a) {
      this.removeObject(a);
      for (
        var b = a.first;
    ...
    (d.WebGLRenderGroup.prototype.addFilterBlocks = function (a, b) {
    ...
    (d.WebGLRenderGroup.prototype.removeFilterBlocks = function (a, b) {
      this.removeObject(a), this.removeObject(b);
    }),
    (d.WebGLRenderGroup.prototype.addDisplayObjectAndChildren = function (a) {
      a.__renderGroup && a.__renderGroup.removeDisplayObjectAndChildren(a);
      for (
        var b = a.first;
        b != this.root.first &&
    ...
    (d.WebGLRenderGroup.prototype.removeDisplayObjectAndChildren = function (
      a
    ) {
    ...
    (d.WebGLRenderGroup.prototype.insertObject = function (a, b, c) {
      var e = b,
        f = c;
      if (a instanceof d.Sprite) {
        var g, h;
        if (e instanceof d.Sprite) {
          if (
            ((g = e.batch),
            g &&
        ...
        if (f)
          if (f instanceof d.Sprite) {
            if ((h = f.batch)) {
              ...
              if (h == g) {
                var i = g.split(f),
                  j = d.WebGLRenderer.getBatch(),
                  k = this.batchs.indexOf(g);
                return j.init(a), this.batchs.splice(k + 1, 0, j, i), void 0;
              }
            }
          } else h = f;
        var j = d.WebGLRenderer.getBatch();
        if ((j.init(a), g)) {
          var k = this.batchs.indexOf(g);
          this.batchs.splice(k + 1, 0, j);
        } else this.batchs.push(j);
      } else
        a instanceof d.TilingSprite
          ? this.initTilingSprite(a)
          : a instanceof d.Strip && this.initStrip(a),
          this.insertAfter(a, e);
    }),
    (d.WebGLRenderGroup.prototype.insertAfter = function (a, b) {
      if (b instanceof d.Sprite) {
        var c = b.batch;
        if (c)
          if (c.tail == b) {
    ...
    (d.WebGLRenderGroup.prototype.removeObject = function (a) {
      var b;
      if (a instanceof d.Sprite) {
        var c = a.batch;
        if (!c) return;
      ...
      if (b) {
        ...
        if (0 == e || e == this.batchs.length - 1)
          return (
            ...
            b instanceof d.WebGLBatch && d.WebGLRenderer.returnBatch(b),
            void 0
          );
        if (
          this.batchs[e - 1] instanceof d.WebGLBatch &&
          this.batchs[e + 1] instanceof d.WebGLBatch &&
          ...
          return (
            ...
            b instanceof d.WebGLBatch && d.WebGLRenderer.returnBatch(b),
            d.WebGLRenderer.returnBatch(this.batchs[e + 1]),
    ...
    (d.WebGLRenderGroup.prototype.initTilingSprite = function (a) {
      var b = this.gl;
    ...
    (d.WebGLRenderGroup.prototype.renderStrip = function (a, b) {
      var c = this.gl,
        e = d.shaderProgram;
      c.useProgram(d.stripShaderProgram);
      var f = d.mat3.clone(a.worldTransform);
      d.mat3.transpose(f),
        c.uniformMatrix3fv(d.stripShaderProgram.translationMatrix, !1, f),
        c.uniform2f(d.stripShaderProgram.projectionVector, b.x, b.y),
        c.uniform1f(d.stripShaderProgram.alpha, a.worldAlpha),
        a.dirty
          ? ((a.dirty = !1),
        ...
        c.useProgram(d.shaderProgram);
    }),
    (d.WebGLRenderGroup.prototype.renderTilingSprite = function (a, b) {
      var c = this.gl;
      d.shaderProgram;
    ...
    (d.WebGLRenderGroup.prototype.initStrip = function (a) {
      var b = this.gl;
      this.shaderProgram,
        (a._vertexBuffer = b.createBuffer()),
        (a._indexBuffer = b.createBuffer()),
    ...
    (d.initPrimitiveShader = function () {
      var a = d.gl,
        b = d.compileProgram(
          d.primitiveShaderVertexSrc,
          d.primitiveShaderFragmentSrc
      ...
      a.useProgram(b),
        ...
        (d.primitiveProgram = b);
    }),
    (d.initDefaultShader = function () {
      var a = this.gl,
        b = d.compileProgram(d.shaderVertexSrc, d.shaderFragmentSrc);
      a.useProgram(b),
        (b.vertexPositionAttribute = a.getAttribLocation(b, "aVertexPosition")),
        (b.projectionVector = a.getUniformLocation(b, "projectionVector")),
    ...
    (d.initDefaultStripShader = function () {
      var a = this.gl,
        b = d.compileProgram(d.stripShaderVertexSrc, d.stripShaderFragmentSrc);
      a.useProgram(b),
        (b.vertexPositionAttribute = a.getAttribLocation(b, "aVertexPosition")),
        (b.projectionVector = a.getUniformLocation(b, "projectionVector")),
        (b.textureCoordAttribute = a.getAttribLocation(b, "aTextureCoord")),
    ...
    (d._CompileShader = function (a, b, c) {
      ...
      return (
        ...
        a.getShaderParameter(e, a.COMPILE_STATUS)
          ? e
          : (alert(a.getShaderInfoLog(e)), null)
      );
    }),
    (d.compileProgram = function (a, b) {
      var c = d.gl,
        e = d.CompileFragmentShader(c, b),
        f = d.CompileVertexShader(c, a),
        g = c.createProgram();
      return (
        c.attachShader(g, f),
        c.attachShader(g, e),
        c.linkProgram(g),
        c.getProgramParameter(g, c.LINK_STATUS) ||
          alert("Could not initialise shaders"),
        g
      );
    }),
    (d.activateDefaultShader = function () {
      var a = d.gl,
        b = d.shaderProgram;
      a.useProgram(b),
    ...
    (d.activatePrimitiveShader = function () {
      var a = d.gl;
      a.disableVertexAttribArray(d.shaderProgram.textureCoordAttribute),
        a.disableVertexAttribArray(d.shaderProgram.colorAttribute),
        a.useProgram(d.primitiveProgram),
        a.enableVertexAttribArray(d.primitiveProgram.vertexPositionAttribute),
        a.enableVertexAttribArray(d.primitiveProgram.colorAttribute);
    }),
    (d.BitmapText = function (a, b) {
      d.DisplayObjectContainer.call(this),
        this.setText(a),
        this.setStyle(b),
        this.updateText(),
    ...
    (d.BitmapText.prototype = Object.create(
      d.DisplayObjectContainer.prototype
    )),
      ...
      (this.fontName = b[b.length - 1]),
        (this.fontSize =
          b.length >= 2
            ...
            : d.BitmapText.fonts[this.fontName].size),
        (this.dirty = !0);
    }),
    (d.BitmapText.prototype.updateText = function () {
      for (
        var a = d.BitmapText.fonts[this.fontName],
          b = new d.Point(),
          c = null,
          e = [],
          f = 0,
      ...
      for (j = 0; j < e.length; j++) {
        var o = new d.Sprite(e[j].texture);
    ...
    (d.Sprite.prototype.setText = function (a) {
    ...
    (d.Text.prototype.updateText = function () {
      ...
      for (
        ...
        "right" == this.style.align
          ? (i.x += e - c[f])
          : "center" == this.style.align && (i.x += (e - c[f]) / 2),
          this.style.stroke &&
            this.style.strokeThickness &&
    ...
    (d.Text.prototype.updateTexture = function () {
      (this.texture.baseTexture.width = this.canvas.width),
        ...
        d.texturesToUpdate.push(this.texture.baseTexture);
    }),
    (d.Text.prototype.updateTransform = function () {
      this.dirty && (this.updateText(), (this.dirty = !1)),
        d.Sprite.prototype.updateTransform.call(this);
    }),
    ...
    (d.Text.prototype.wordWrap = function (a) {
      for (
        var b = function (a, b, c, d, e) {
            var f = Math.floor((d - c) / 2) + c;
            return f == c
              ? 1
              : a.measureText(b.substring(0, f)).width <= e
              ? a.measureText(b.substring(0, f + 1)).width > e
                ? f
                : arguments.callee(a, b, f, d, e)
              : arguments.callee(a, b, c, f, e);
          },
          c = function (a, c, d) {
            if (a.measureText(c).width <= d || c.length < 1) return c;
            var e = b(a, c, 0, c.length, d);
            return (
              c.substring(0, e) + "\n" + arguments.callee(a, c.substring(e), d)
            );
          },
          d = "",
          e = a.split("\n"),
    ...
    (d.texturesToUpdate = []),
    (d.texturesToDestroy = []),
    (d.BaseTexture = function (a) {
      if (
        (d.EventTarget.call(this),
        (this.width = 100),
        (this.height = 100),
        (this.hasLoaded = !1),
        (this.source = a),
    ...
    (d.BaseTexture.prototype.destroy = function () {
      this.source instanceof Image && (this.source.src = null),
        (this.source = null),
        d.texturesToDestroy.push(this);
    }),
    (d.BaseTexture.fromImage = function (a, b) {
      var c = d.BaseTextureCache[a];
      if (!c) {
        var e = new Image();
        b && (e.crossOrigin = ""),
          (e.src = a),
          (c = new d.BaseTexture(e)),
          (d.BaseTextureCache[a] = c);
      }
      return c;
    }),
    (d.TextureCache = {}),
    ...
    (d.Texture = function (a, b) {
      if (
        (d.EventTarget.call(this),
        b || ((this.noFrame = !0), (b = new d.Rectangle(0, 0, 1, 1))),
        a instanceof d.Texture && (a = a.baseTexture),
        (this.baseTexture = a),
        (this.frame = b),
        (this.trim = new d.Point()),
        (this.scope = this),
        a.hasLoaded)
      )
        this.noFrame && (b = new d.Rectangle(0, 0, a.width, a.height)),
          this.setFrame(b);
      else {
        var c = this;
    ...
    (d.Texture.prototype.onBaseTextureLoaded = function () {
      ...
      a.removeEventListener("loaded", this.onLoaded),
        this.noFrame && (this.frame = new d.Rectangle(0, 0, a.width, a.height)),
        (this.noFrame = !1),
    ...
    (d.Texture.fromImage = function (a, b) {
      var c = d.TextureCache[a];
      return (
        c ||
          ((c = new d.Texture(d.BaseTexture.fromImage(a, b))),
          (d.TextureCache[a] = c)),
        c
      );
    }),
    ...
    (d.Texture.fromCanvas = function (a) {
      var b = new d.BaseTexture(a);
      return new d.Texture(b);
    }),
    ...
    (d.Texture.removeTextureFromCache = function (a) {
      var b = d.TextureCache[a];
      return (d.TextureCache[a] = null), b;
    }),
    (d.Texture.frameUpdates = []),
    (d.RenderTexture = function (a, b) {
      d.EventTarget.call(this),
        (this.width = a || 100),
        (this.height = b || 100),
        (this.indetityMatrix = d.mat3.create()),
        (this.frame = new d.Rectangle(0, 0, this.width, this.height)),
        d.gl ? this.initWebGL() : this.initCanvas();
    }),
    ...
    (d.RenderTexture.prototype.initWebGL = function () {
      ...
      (this.glFramebuffer = a.createFramebuffer()),
        ...
        (this.projection = new d.Point(this.width / 2, this.height / 2)),
        (this.render = this.renderWebGL);
    }),
    (d.RenderTexture.prototype.resize = function (a, b) {
      if (((this.width = a), (this.height = b), d.gl)) {
    ...
    (d.RenderTexture.prototype.initCanvas = function () {
      (this.renderer = new d.CanvasRenderer(this.width, this.height, null, 0)),
        (this.baseTexture = new d.BaseTexture(this.renderer.view)),
        (this.frame = new d.Rectangle(0, 0, this.width, this.height)),
    ...
    (d.RenderTexture.prototype.renderWebGL = function (a, b, c) {
      ...
      e.colorMask(!0, !0, !0, !0),
        ...
        c && (e.clearColor(0, 0, 0, 0), e.clear(e.COLOR_BUFFER_BIT));
      var f = a.children,
        g = a.worldTransform;
      (a.worldTransform = d.mat3.create()),
        (a.worldTransform[4] = -1),
        (a.worldTransform[5] = 2 * this.projection.y),
        b && ((a.worldTransform[2] = b.x), (a.worldTransform[5] -= b.y)),
        d.visibleCount++,
        (a.vcount = d.visibleCount);
      for (var h = 0, i = f.length; i > h; h++) f[h].updateTransform();
      var j = a.__renderGroup;
      j
        ? a == j.root
          ? j.render(this.projection)
          : j.renderSpecific(a, this.projection)
        : (this.renderGroup || (this.renderGroup = new d.WebGLRenderGroup(e)),
    ...
    (d.PolyK = {}),
    (d.PolyK.Triangulate = function (a) {
      var b = !0,
        c = a.length >> 1;
      if (3 > c) return [];
        ...
        if (d.PolyK._convex(l, m, n, o, p, q, b)) {
          ...
          for (var s = 0; h > s; s++) {
            ...
            if (
              ...
              t != j &&
              t != k &&
              d.PolyK._PointInTriangle(a[2 * t], a[2 * t + 1], l, m, n, o, p, q)
            ) {
              r = !1;
              break;
            }
    ...
    (e.Camera = function (a, b, c, d, f, g) {
      (this.game = a),
        (this.world = a.world),
        (this.id = 0),
        (this.view = new e.Rectangle(c, d, f, g)),
        (this.screenView = new e.Rectangle(c, d, f, g)),
        (this.bounds = new e.Rectangle(c, d, f, g)),
        (this.deadzone = null),
        (this.visible = !0),
    ...
    (e.Camera.FOLLOW_LOCKON = 0),
    (e.Camera.FOLLOW_PLATFORMER = 1),
    (e.Camera.FOLLOW_TOPDOWN = 2),
    (e.Camera.FOLLOW_TOPDOWN_TIGHT = 3),
    (e.Camera.prototype = {
      follow: function (a, b) {
        "undefined" == typeof b && (b = e.Camera.FOLLOW_LOCKON),
          (this.target = a);
        var c;
        switch (b) {
    ...
    Object.defineProperty(e.Camera.prototype, "x", {
      get: function () {
        return this.view.x;
      },
      set: function (a) {
    ...
    (e.StateManager.prototype = {
      ...
      add: function (a, b, c) {
        ...
        var d;
        return (
          b instanceof e.State
            ? (d = b)
            : "object" == typeof b
            ? ((d = b), (d.game = this.game))
            : "function" == typeof b && (d = new b(this.game)),
          (this.states[a] = d),
      ...
      checkState: function (a) {
        if (this.states[a]) {
          ...
          return (
            ...
            0 == b && this.states[a].loadRender && (b = !0),
            0 == b && this.states[a].loadUpdate && (b = !0),
            0 == b && this.states[a].create && (b = !0),
            0 == b && this.states[a].update && (b = !0),
            0 == b && this.states[a].preRender && (b = !0),
            0 == b && this.states[a].render && (b = !0),
            0 == b && this.states[a].paused && (b = !0),
            0 == b
              ? (console.warn(
      ...
      loadComplete: function () {
        0 == this._created && this.onCreateCallback
          ? ((this._created = !0),
    ...
    (e.Signal = function () {
      ...
      this.dispatch = function () {
        e.Signal.prototype.dispatch.apply(a, arguments);
      };
    }),
    (e.Signal.prototype = {
      memorize: !1,
      ...
      _registerListener: function (a, b, c, d) {
        ...
        } else (f = new e.SignalBinding(this, a, b, c, d)), this._addBinding(f);
        return (
    ...
    (e.SignalBinding = function (a, b, c, d, e) {
      (this._listener = b),
        (this._isOnce = c),
        (this.context = d),
        (this._signal = a),
    ...
    (e.PluginManager.prototype = {
      add: function (a) {
        ...
        return (
          ...
          b
            ? ((a.hasPreUpdate || a.hasUpdate) && (a.active = !0),
    ...
    (e.Stage = function (a, b, c) {
      (this.game = a),
        (this._backgroundColor = "rgb(0,0,0)"),
        (this.offset = new e.Point()),
        (this.canvas = e.Canvas.create(b, c)),
        (this.canvas.style["-webkit-full-screen"] =
          "width: 100%; height: 100%"),
        (this._stage = new d.Stage(0, !1)),
        (this._stage.name = "_stage_root"),
        (this.scaleMode = e.StageScaleMode.NO_SCALE),
        (this.scale = new e.StageScaleMode(this.game, b, c)),
        (this.aspectRatio = b / c),
        (this._nextOffsetCheck = 0),
        (this.checkOffsetInterval = 2500);
    }),
    (e.Stage.prototype = {
      boot: function () {
        e.Canvas.getOffset(this.canvas, this.offset),
        ...
        (this._onChange = function (b) {
          ...
          e.Canvas.setUserSelect(this.canvas, "none"),
          e.Canvas.setTouchAction(this.canvas, "none"),
    ...
    Object.defineProperty(e.Stage.prototype, "backgroundColor", {
      ...
      set: function (a) {
        (this._backgroundColor = a),
          this.game.renderType == e.CANVAS
            ? (this._stage.backgroundColorString = a)
            : ("string" == typeof a && (a = e.Color.hexToRGB(a)),
              this._stage.setBackgroundColor(a));
      },
    }),
    (e.Group = function (a, b, c, f) {
      "undefined" == typeof b && (b = a.world),
        ...
        f
          ...
          : ((this._container = new d.DisplayObjectContainer()),
            (this._container.name = this.name),
            b
              ? b instanceof e.Group
    ...
    (e.Group.prototype = {
      ...
      create: function (a, b, c, d, f) {
        ...
        var g = new e.Sprite(this.game, a, b, c, d);
        return (
          (g.group = this),
          (g.exists = f),
          (g.visible = f),
      ...
      createMultiple: function (a, b, c, d) {
        "undefined" == typeof d && (d = !1);
        for (var f = 0; a > f; f++) {
          var g = new e.Sprite(this.game, 0, 0, b, c);
          (g.group = this),
            (g.exists = d),
            (g.visible = d),
            (g.alive = d),
      ...
      callAll: function (a, b) {
        if ("undefined" != typeof a) {
          ...
          if (
            ...
            var g = this._container.first._iNext;
            do
              (f = this.callbackFromArray(g, a, c)),
                b && f
                  ? ((callbackContext = this.callbackFromArray(g, b, d)),
                    f && f.apply(callbackContext, e))
                  : f && f.apply(g, e),
                (g = g._iNext);
            while (g != this._container.last._iNext);
          }
        }
      },
      forEach: function (a, b, c) {
        ...
        if (
          ...
          do
            (0 == c || (c && e.exists)) && ((d[0] = e), a.apply(b, d)),
              (e = e._iNext);
      ...
      forEachAlive: function (a, b) {
        ...
        if (
          ...
          var d = this._container.first._iNext;
          do d.alive && ((c[0] = d), a.apply(b, c)), (d = d._iNext);
          while (d != this._container.last._iNext);
        }
      },
      forEachDead: function (a, b) {
        ...
        if (
          ...
          var d = this._container.first._iNext;
          do 0 == d.alive && ((c[0] = d), a.apply(b, c)), (d = d._iNext);
          while (d != this._container.last._iNext);
        }
      },
      ...
      dump: function (a) {
        ...
        var c =
          ...
          e.Utils.pad("----------", b);
        if ((console.log(c), a))
          var d = this.game.stage._stage.last._iNext,
            f = this.game.stage._stage;
        else
          var d = this._container.last._iNext,
            f = this._container;
        do {
          var g = f.name || "*";
    ...
    Object.defineProperty(e.Group.prototype, "x", {
      get: function () {
    ...
    Object.defineProperty(e.Group.prototype, "y", {
      get: function () {
    ...
    Object.defineProperty(e.Group.prototype, "angle", {
      get: function () {
        return e.Math.radToDeg(this._container.rotation);
      },
      set: function (a) {
        this._container.rotation = e.Math.degToRad(a);
      },
    }),
    Object.defineProperty(e.Group.prototype, "rotation", {
      get: function () {
    ...
    Object.defineProperty(e.Group.prototype, "visible", {
      get: function () {
    ...
    Object.defineProperty(e.Group.prototype, "alpha", {
      get: function () {
    ...
    (e.World = function (a) {
      e.Group.call(this, a, null, "__world", !1),
        (this.scale = new e.Point(1, 1)),
        (this.bounds = new e.Rectangle(0, 0, a.width, a.height)),
        (this.camera = null),
        (this.currentRenderOrderID = 0);
    }),
    (e.World.prototype = Object.create(e.Group.prototype)),
    (e.World.prototype.constructor = e.World),
    (e.World.prototype.boot = function () {
    ...
    (e.World.prototype.update = function () {
      if (
        ((this.currentRenderOrderID = 0), this.game.stage._stage.first._iNext)
      ) {
        var a = this.game.stage._stage.first._iNext;
        do a.preUpdate && a.preUpdate(), a.update && a.update(), (a = a._iNext);
        while (a != this.game.stage._stage.last._iNext);
      }
    }),
    (e.World.prototype.postUpdate = function () {
      if ((this.camera.update(), this.game.stage._stage.first._iNext)) {
        var a = this.game.stage._stage.first._iNext;
        do a.postUpdate && a.postUpdate(), (a = a._iNext);
        while (a != this.game.stage._stage.last._iNext);
      }
    }),
    (e.World.prototype.setBounds = function (a, b, c, d) {
      this.bounds.setTo(a, b, c, d),
        this.camera.bounds && this.camera.bounds.setTo(a, b, c, d);
    }),
    (e.World.prototype.destroy = function () {
      (this.camera.x = 0),
        (this.camera.y = 0),
    ...
    (e.Game = function (a, b, c, d, f, g, h) {
      (a = a || 800),
        ...
        (this.antialias = h),
        (this.renderer = null),
        (this.state = new e.StateManager(this, f)),
        (this._paused = !1),
        (this.renderType = c),
    ...
    (e.Game.prototype = {
        ...
        this.isBooted ||
          (document.body
            ? (document.removeEventListener("DOMContentLoaded", this._onBoot),
              ...
              (this.onPause = new e.Signal()),
              (this.onResume = new e.Signal()),
              (this.isBooted = !0),
              (this.device = new e.Device()),
              (this.math = e.Math),
              (this.rnd = new e.RandomDataGenerator([
                (Date.now() * Math.random()).toString(),
              ])),
              (this.stage = new e.Stage(this, this.width, this.height)),
              this.setUpRenderer(),
              (this.world = new e.World(this)),
              (this.add = new e.GameObjectFactory(this)),
              (this.cache = new e.Cache(this)),
              (this.load = new e.Loader(this)),
              (this.time = new e.Time(this)),
              (this.tweens = new e.TweenManager(this)),
              (this.input = new e.Input(this)),
              (this.sound = new e.SoundManager(this)),
              (this.physics = new e.Physics.Arcade(this)),
              (this.particles = new e.Particles(this)),
              (this.plugins = new e.PluginManager(this, this)),
              (this.net = new e.Net(this)),
              (this.debug = new e.Utils.Debug(this)),
              this.stage.boot(),
              this.world.boot(),
              this.input.boot(),
              this.sound.boot(),
              ...
              (this.isRunning = !0),
              (this._loadComplete = !1),
              (this.raf = new e.RequestAnimationFrame(this)),
              this.raf.start())
      ...
      showDebugHeader: function () {
        var a = e.DEV_VERSION,
          ...
          c = "HTML Audio";
        if (
          (this.renderType == e.WEBGL && (b = "WebGL"),
      ...
      setUpRenderer: function () {
        if (
          this.renderType === e.CANVAS ||
          (this.renderType === e.AUTO && 0 == this.device.webGL)
        ) {
          ...
          (this.renderType = e.CANVAS),
            (this.renderer = new d.CanvasRenderer(
              this.width,
              this.height,
              this.stage.canvas,
              this.transparent
            )),
            e.Canvas.setSmoothingEnabled(this.renderer.context, this.antialias),
            (this.canvas = this.renderer.view),
            (this.context = this.renderer.context);
        } else
          (this.renderType = e.WEBGL),
            ...
            (this.canvas = this.renderer.view),
            (this.context = null);
        e.Canvas.addToDOM(this.renderer.view, this.parent, !0),
          e.Canvas.setTouchAction(this.renderer.view);
      },
      loadComplete: function () {
    ...
    Object.defineProperty(e.Game.prototype, "paused", {
      get: function () {
        return this._paused;
      },
      set: function (a) {
    ...
    (e.Input.MOUSE_OVERRIDES_TOUCH = 0),
    (e.Input.TOUCH_OVERRIDES_MOUSE = 1),
    (e.Input.MOUSE_TOUCH_COMBINE = 2),
    (e.Input.prototype = {
      game: null,
      pollRate: 0,
      _pollCounter: 0,
      ...
      _y: 0,
      disabled: !1,
      multiInputOverride: e.Input.MOUSE_TOUCH_COMBINE,
      position: null,
      speed: null,
      circle: null,
      scale: null,
      ...
      onTap: null,
      onHold: null,
      interactiveItems: new e.LinkedList(),
      boot: function () {
        (this.mousePointer = new e.Pointer(this.game, 0)),
          (this.pointer1 = new e.Pointer(this.game, 1)),
          (this.pointer2 = new e.Pointer(this.game, 2)),
          (this.mouse = new e.Mouse(this.game)),
          (this.keyboard = new e.Keyboard(this.game)),
          (this.touch = new e.Touch(this.game)),
          (this.mspointer = new e.MSPointer(this.game)),
          (this.onDown = new e.Signal()),
          (this.onUp = new e.Signal()),
          (this.onTap = new e.Signal()),
          (this.onHold = new e.Signal()),
          (this.scale = new e.Point(1, 1)),
          (this.speed = new e.Point()),
          (this.position = new e.Point()),
          (this._oldPosition = new e.Point()),
          (this.circle = new e.Circle(0, 0, 44)),
      ...
      addPointer: function () {
        ...
        return 0 == a
          ...
          : ((this["pointer" + a] = new e.Pointer(this.game, a)),
            this["pointer" + a]);
      },
      update: function () {
      ...
      startPointer: function (a) {
        ...
        for (var b = 3; 10 >= b; b++)
          if (this["pointer" + b] && 0 == this["pointer" + b].active)
    ...
    Object.defineProperty(e.Input.prototype, "x", {
      get: function () {
        return this._x;
      },
      set: function (a) {
    ...
    (e.Key.prototype = {
      ...
      justReleased: function (a) {
        return (
          ...
          0 == this.isDown && this.game.time.now - this.timeUp < a
        );
      },
    }),
    ...
    (e.Keyboard.prototype = {
      ...
      addKey: function (a) {
        return (
          (this._hotkeys[a] = new e.Key(this.game, a)),
      ...
      createCursorKeys: function () {
        return {
          up: this.addKey(e.Keyboard.UP),
          down: this.addKey(e.Keyboard.DOWN),
          left: this.addKey(e.Keyboard.LEFT),
          right: this.addKey(e.Keyboard.RIGHT),
        };
      },
      start: function () {
        var a = this;
        (this._onKeyDown = function (b) {
          ...
          document.body.addEventListener("keydown", this._onKeyDown, !1),
          document.body.addEventListener("keyup", this._onKeyUp, !1);
      },
      stop: function () {
    ...
    (e.Keyboard.A = "A".charCodeAt(0)),
    (e.Keyboard.B = "B".charCodeAt(0)),
    (e.Keyboard.C = "C".charCodeAt(0)),
    (e.Keyboard.D = "D".charCodeAt(0)),
    (e.Keyboard.E = "E".charCodeAt(0)),
    (e.Keyboard.F = "F".charCodeAt(0)),
    (e.Keyboard.G = "G".charCodeAt(0)),
    (e.Keyboard.H = "H".charCodeAt(0)),
    (e.Keyboard.I = "I".charCodeAt(0)),
    (e.Keyboard.J = "J".charCodeAt(0)),
    (e.Keyboard.K = "K".charCodeAt(0)),
    (e.Keyboard.L = "L".charCodeAt(0)),
    (e.Keyboard.M = "M".charCodeAt(0)),
    (e.Keyboard.N = "N".charCodeAt(0)),
    (e.Keyboard.O = "O".charCodeAt(0)),
    (e.Keyboard.P = "P".charCodeAt(0)),
    (e.Keyboard.Q = "Q".charCodeAt(0)),
    (e.Keyboard.R = "R".charCodeAt(0)),
    (e.Keyboard.S = "S".charCodeAt(0)),
    (e.Keyboard.T = "T".charCodeAt(0)),
    (e.Keyboard.U = "U".charCodeAt(0)),
    (e.Keyboard.V = "V".charCodeAt(0)),
    (e.Keyboard.W = "W".charCodeAt(0)),
    (e.Keyboard.X = "X".charCodeAt(0)),
    (e.Keyboard.Y = "Y".charCodeAt(0)),
    (e.Keyboard.Z = "Z".charCodeAt(0)),
    (e.Keyboard.ZERO = "0".charCodeAt(0)),
    (e.Keyboard.ONE = "1".charCodeAt(0)),
    (e.Keyboard.TWO = "2".charCodeAt(0)),
    (e.Keyboard.THREE = "3".charCodeAt(0)),
    (e.Keyboard.FOUR = "4".charCodeAt(0)),
    (e.Keyboard.FIVE = "5".charCodeAt(0)),
    (e.Keyboard.SIX = "6".charCodeAt(0)),
    (e.Keyboard.SEVEN = "7".charCodeAt(0)),
    (e.Keyboard.EIGHT = "8".charCodeAt(0)),
    (e.Keyboard.NINE = "9".charCodeAt(0)),
    (e.Keyboard.NUMPAD_0 = 96),
    (e.Keyboard.NUMPAD_1 = 97),
    (e.Keyboard.NUMPAD_2 = 98),
    (e.Keyboard.NUMPAD_3 = 99),
    (e.Keyboard.NUMPAD_4 = 100),
    (e.Keyboard.NUMPAD_5 = 101),
    (e.Keyboard.NUMPAD_6 = 102),
    (e.Keyboard.NUMPAD_7 = 103),
    (e.Keyboard.NUMPAD_8 = 104),
    (e.Keyboard.NUMPAD_9 = 105),
    (e.Keyboard.NUMPAD_MULTIPLY = 106),
    (e.Keyboard.NUMPAD_ADD = 107),
    (e.Keyboard.NUMPAD_ENTER = 108),
    (e.Keyboard.NUMPAD_SUBTRACT = 109),
    (e.Keyboard.NUMPAD_DECIMAL = 110),
    (e.Keyboard.NUMPAD_DIVIDE = 111),
    (e.Keyboard.F1 = 112),
    (e.Keyboard.F2 = 113),
    (e.Keyboard.F3 = 114),
    (e.Keyboard.F4 = 115),
    ...
    (e.Keyboard.F14 = 125),
    (e.Keyboard.F15 = 126),
    (e.Keyboard.COLON = 186),
    (e.Keyboard.EQUALS = 187),
    (e.Keyboard.UNDERSCORE = 189),
    (e.Keyboard.QUESTION_MARK = 191),
    (e.Keyboard.TILDE = 192),
    (e.Keyboard.OPEN_BRACKET = 219),
    (e.Keyboard.BACKWARD_SLASH = 220),
    (e.Keyboard.CLOSED_BRACKET = 221),
    (e.Keyboard.QUOTES = 222),
    (e.Keyboard.BACKSPACE = 8),
    (e.Keyboard.TAB = 9),
    (e.Keyboard.CLEAR = 12),
    (e.Keyboard.ENTER = 13),
    (e.Keyboard.SHIFT = 16),
    (e.Keyboard.CONTROL = 17),
    (e.Keyboard.ALT = 18),
    (e.Keyboard.CAPS_LOCK = 20),
    (e.Keyboard.ESC = 27),
    (e.Keyboard.SPACEBAR = 32),
    (e.Keyboard.PAGE_UP = 33),
    (e.Keyboard.PAGE_DOWN = 34),
    (e.Keyboard.END = 35),
    (e.Keyboard.HOME = 36),
    (e.Keyboard.LEFT = 37),
    (e.Keyboard.UP = 38),
    (e.Keyboard.RIGHT = 39),
    (e.Keyboard.DOWN = 40),
    (e.Keyboard.INSERT = 45),
    (e.Keyboard.DELETE = 46),
    (e.Keyboard.HELP = 47),
    (e.Keyboard.NUM_LOCK = 144),
    (e.Mouse = function (a) {
      (this.game = a),
    ...
    (e.Mouse.LEFT_BUTTON = 0),
    (e.Mouse.MIDDLE_BUTTON = 1),
    (e.Mouse.RIGHT_BUTTON = 2),
    (e.Mouse.prototype = {
      start: function () {
        var a = this;
        (this.game.device.android && 0 == this.game.device.chrome) ||
      ...
      pointerLockChange: function () {
        var a = this.game.stage.canvas;
        this.locked =
          document.pointerLockElement === a ||
          document.mozPointerLockElement === a ||
          document.webkitPointerLockElement === a
            ? !0
            : !1;
      },
    ...
    (e.Pointer.prototype = {
      start: function (a) {
        return (
          ...
          1 == this.game.paused &&
          0 == this.game.stage.scale.incorrectOrientation
            ...
            : ((this._history.length = 0),
              ...
              (this.game.input.multiInputOverride ==
                ...
                this.game.input.multiInputOverride ==
                  e.Input.MOUSE_TOUCH_COMBINE ||
                (this.game.input.multiInputOverride ==
                  e.Input.TOUCH_OVERRIDES_MOUSE &&
              ...
              (this._stateReset = !1),
              this.totalTouches++,
              0 == this.isMouse && this.game.input.currentPointers++,
      ...
      move: function (a) {
        if (!this.game.input.pollLocked) {
          if (
            ...
            return this;
          if (null !== this.targetObject && 1 == this.targetObject.isDragged)
            return (
              0 == this.targetObject.update(this) && (this.targetObject = null),
              this
            );
          if (
          ...
          return (
            null == this._highestRenderObject
              ...
              : this.targetObject == this._highestRenderObject
              ? 0 == this._highestRenderObject.update(this) &&
                (this.targetObject = null)
              : (this.targetObject._pointerOutHandler(this),
                (this.targetObject = this._highestRenderObject),
      ...
      stop: function (a) {
        ...
        if (
          ...
          (this.game.input.multiInputOverride ==
            e.Input.MOUSE_OVERRIDES_TOUCH ||
            this.game.input.multiInputOverride == e.Input.MOUSE_TOUCH_COMBINE ||
            (this.game.input.multiInputOverride ==
              e.Input.TOUCH_OVERRIDES_MOUSE &&
              0 == this.game.input.currentPointers)) &&
    ...
    Object.defineProperty(e.Pointer.prototype, "duration", {
      get: function () {
    ...
    (e.InputHandler.prototype = {
      start: function (a, b) {
        if (
          ((a = a || 0), "undefined" == typeof b && (b = !1), 0 == this.enabled)
        ) {
          ...
          (this.snapOffset = new e.Point()),
            (this.enabled = !0),
            this.sprite.events &&
              null == this.sprite.events.onInputOver &&
              ((this.sprite.events.onInputOver = new e.Signal()),
              (this.sprite.events.onInputOut = new e.Signal()),
              (this.sprite.events.onInputDown = new e.Signal()),
              (this.sprite.events.onInputUp = new e.Signal()),
              (this.sprite.events.onDragStart = new e.Signal()),
              (this.sprite.events.onDragStop = new e.Signal()));
        }
        return this.sprite;
      },
      reset: function () {
      ...
      pointerOver: function (a) {
        return (a = a || 0), this._pointerData[a].isOver;
      },
      pointerOut: function (a) {
        return (a = a || 0), this._pointerData[a].isOut;
      },
      ...
      update: function (a) {
        return 0 == this.enabled ||
          0 == this.sprite.visible ||
          (this.sprite.group && 0 == this.sprite.group.visible)
          ? (this._pointerOutHandler(a), !1)
          : this.draggable && this._draggedPointerID == a.id
          ? this.updateDrag(a)
          : 1 == this._pointerData[a.id].isOver
      ...
      _pointerOverHandler: function (a) {
        0 == this._pointerData[a.id].isOver &&
          ...
          (this._pointerData[a.id].y = a.y - this.sprite.y),
          this.useHandCursor &&
            0 == this._pointerData[a.id].isDragged &&
      ...
      _touchedHandler: function (a) {
        return (
          0 == this._pointerData[a.id].isDown &&
            1 == this._pointerData[a.id].isOver &&
            ...
            this.draggable && 0 == this.isDragged && this.startDrag(a),
      ...
      enableDrag: function (a, b, c, d, f, g) {
        "undefined" == typeof a && (a = !1),
          ...
          (f = f || null),
          (g = g || null),
          (this._dragPoint = new e.Point()),
          (this.draggable = !0),
          (this.bringToTop = b),
          (this.dragOffset = new e.Point()),
      ...
      stopDrag: function (a) {
        (this.isDragged = !1),
          ...
          this.sprite.events.onInputUp.dispatch(this.sprite, a),
          0 == this.checkPointerOver(a) && this._pointerOutHandler(a);
      },
    ...
    (e.Events = function (a) {
      (this.parent = a),
        (this.onAddedToGroup = new e.Signal()),
        (this.onRemovedFromGroup = new e.Signal()),
        (this.onKilled = new e.Signal()),
        (this.onRevived = new e.Signal()),
        (this.onOutOfBounds = new e.Signal()),
    ...
    (e.GameObjectFactory = function (a) {
    ...
    (e.GameObjectFactory.prototype = {
      ...
      group: function (a, b) {
        return new e.Group(this.game, a, b);
      },
      audio: function (a, b, c) {
        return this.game.sound.add(a, b, c);
      },
      tileSprite: function (a, b, c, d, f, g) {
        return this.world.add(new e.TileSprite(this.game, a, b, c, d, f, g));
      },
      text: function (a, b, c, d) {
        return this.world.add(new e.Text(this.game, a, b, c, d));
      },
      button: function (a, b, c, d, f, g, h, i) {
        return this.world.add(new e.Button(this.game, a, b, c, d, f, g, h, i));
      },
      graphics: function (a, b) {
        return this.world.add(new e.Graphics(this.game, a, b));
      },
      emitter: function (a, b, c) {
        return this.game.particles.add(
          new e.Particles.Arcade.Emitter(this.game, a, b, c)
        );
      },
      bitmapText: function (a, b, c, d) {
        return this.world.add(new e.BitmapText(this.game, a, b, c, d));
      },
      tilemap: function (a) {
        return new e.Tilemap(this.game, a);
      },
      tileset: function (a) {
        return this.game.cache.getTileset(a);
      },
      tilemapLayer: function (a, b, c, d, f, g, h) {
        return this.world.add(
          new e.TilemapLayer(this.game, a, b, c, d, f, g, h)
        );
      },
      renderTexture: function (a, b, c) {
        var d = new e.RenderTexture(this.game, a, b, c);
        return this.game.cache.addRenderTexture(a, d), d;
      },
    }),
    (e.Sprite = function (a, b, c, f, g) {
      (b = b || 0),
        (c = c || 0),
        (f = f || null),
        (g = g || null),
        ...
        (this.animations = new e.AnimationManager(this)),
        (this.input = new e.InputHandler(this)),
        (this.key = f),
        (this.currentFrame = null),
        f instanceof e.RenderTexture
          ? (d.Sprite.call(this, f),
            (this.currentFrame = this.game.cache.getTextureFrame(f.name)))
          : f instanceof d.Texture
          ? (d.Sprite.call(this, f), (this.currentFrame = g))
          : ((null == f || 0 == this.game.cache.checkImageKey(f)) &&
              ((f = "__default"), (this.key = f)),
            d.Sprite.call(this, d.TextureCache[f]),
        ...
        (this.textureRegion = new e.Rectangle(
        ...
        (this.offset = new e.Point()),
        (this.center = new e.Point(
          b + Math.floor(this._cache.width / 2),
          c + Math.floor(this._cache.height / 2)
        )),
        (this.topLeft = new e.Point(b, c)),
        (this.topRight = new e.Point(b + this._cache.width, c)),
        (this.bottomRight = new e.Point(
          b + this._cache.width,
        ...
        (this.body = new e.Physics.Arcade.Body(this)),
        (this.health = 1),
        (this.inWorld = e.Rectangle.intersects(
          this.bounds,
        ...
        (this.cameraOffset = new e.Point()),
        (this.crop = new e.Rectangle(
          0,
          0,
          this._cache.width,
          this._cache.height
    ...
    (e.Sprite.prototype = Object.create(d.Sprite.prototype)),
    (e.Sprite.prototype.constructor = e.Sprite),
    (e.Sprite.prototype.preUpdate = function () {
      return this.exists
        ? this.lifespan > 0 &&
          ...
          : ((this._cache.dirty = !1),
            ...
            void 0)
        : ((this.renderOrderID = -1), void 0);
    }),
    (e.Sprite.prototype.updateCache = function () {
    ...
    (e.Sprite.prototype.updateAnimation = function () {
    ...
    (e.Sprite.prototype.updateCrop = function () {
      !this.cropEnabled ||
        ...
        d.Texture.frameUpdates.push(this.texture));
    }),
    (e.Sprite.prototype.updateBounds = function () {
      this.offset.setTo(
        ...
        (this._cache.left = e.Math.min(
          this.topLeft.x,
          this.topRight.x,
          this.bottomLeft.x,
          this.bottomRight.x
        )),
        (this._cache.right = e.Math.max(
          this.topLeft.x,
          this.topRight.x,
          this.bottomLeft.x,
          this.bottomRight.x
        )),
        (this._cache.top = e.Math.min(
          this.topLeft.y,
          this.topRight.y,
          this.bottomLeft.y,
          this.bottomRight.y
        )),
        (this._cache.bottom = e.Math.max(
          this.topLeft.y,
          this.topRight.y,
          this.bottomLeft.y,
          this.bottomRight.y
        ...
        (this._cache.cameraVisible = e.Rectangle.intersects(
    ...
    (e.Sprite.prototype.getLocalPosition = function (a, b, c) {
      return (
        (a.x =
    ...
    (e.Sprite.prototype.getLocalUnmodifiedPosition = function (a, b, c) {
      return (
        (a.x =
    ...
    (e.Sprite.prototype.resetCrop = function () {
      (this.crop = new e.Rectangle(
        0,
        0,
        this._cache.width,
    ...
    (e.Sprite.prototype.postUpdate = function () {
      this.exists &&
    ...
    (e.Sprite.prototype.loadTexture = function (a, b) {
      (this.key = a),
        a instanceof e.RenderTexture
          ? (this.currentFrame = this.game.cache.getTextureFrame(a.name))
          : a instanceof d.Texture
          ? (this.currentFrame = b)
          : (("undefined" == typeof a ||
            ...
            this.game.cache.isSpriteSheet(a)
              ...
              : ((this.currentFrame = this.game.cache.getFrame(a)),
                this.setTexture(d.TextureCache[a])));
    }),
    (e.Sprite.prototype.centerOn = function (a, b) {
      return (
    ...
    (e.Sprite.prototype.revive = function (a) {
      return (
        "undefined" == typeof a && (a = 1),
        (this.alive = !0),
        (this.exists = !0),
    ...
    (e.Sprite.prototype.kill = function () {
      return (
        (this.alive = !1),
        (this.exists = !1),
        (this.visible = !1),
    ...
    (e.Sprite.prototype.damage = function (a) {
      return (
        this.alive && ((this.health -= a), this.health < 0 && this.kill()), this
      );
    }),
    (e.Sprite.prototype.reset = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = 1),
        (this.x = a),
        (this.y = b),
    ...
    (e.Sprite.prototype.bringToTop = function () {
      return (
        this.group
    ...
    (e.Sprite.prototype.play = function (a, b, c, d) {
      return this.animations ? this.animations.play(a, b, c, d) : void 0;
    }),
    Object.defineProperty(e.Sprite.prototype, "angle", {
      get: function () {
        return e.Math.wrapAngle(e.Math.radToDeg(this.rotation));
      },
      set: function (a) {
        this.rotation = e.Math.degToRad(e.Math.wrapAngle(a));
      },
    }),
    Object.defineProperty(e.Sprite.prototype, "frame", {
      get: function () {
    ...
    Object.defineProperty(e.Sprite.prototype, "frameName", {
      get: function () {
    ...
    Object.defineProperty(e.Sprite.prototype, "inCamera", {
      get: function () {
    ...
    Object.defineProperty(e.Sprite.prototype, "inputEnabled", {
      get: function () {
        return this.input.enabled;
      },
      set: function (a) {
        a
          ? 0 == this.input.enabled && this.input.start()
          : this.input.enabled && this.input.stop();
      },
    }),
    (e.TileSprite = function (a, b, c, f, g, h, i) {
      (b = b || 0),
        (c = c || 0),
        (f = f || 256),
        (g = g || 256),
        (h = h || null),
        (i = i || null),
        e.Sprite.call(this, a, b, c, h, i),
        (this.texture = d.TextureCache[h]),
        d.TilingSprite.call(this, this.texture, f, g),
        (this.type = e.TILESPRITE),
        (this.tileScale = new e.Point(1, 1)),
        (this.tilePosition = new e.Point(0, 0));
    }),
    (e.TileSprite.prototype = e.Utils.extend(
      !0,
      d.TilingSprite.prototype,
      e.Sprite.prototype
    )),
    (e.TileSprite.prototype.constructor = e.TileSprite),
    (e.Text = function (a, b, c, f, g) {
      (b = b || 0),
        (c = c || 0),
        (f = f || ""),
        (g = g || ""),
        ...
        (this._text = f),
        (this._style = g),
        d.Text.call(this, f, g),
        (this.type = e.TEXT),
        (this.position.x = this.x = b),
        (this.position.y = this.y = c),
        (this.anchor = new e.Point()),
        (this.scale = new e.Point(1, 1)),
        (this._cache = {
          dirty: !1,
    ...
    (e.Text.prototype = Object.create(d.Text.prototype)),
    (e.Text.prototype.constructor = e.Text),
    (e.Text.prototype.update = function () {
      this.exists &&
        ((this._cache.dirty = !1),
        (this._cache.x = this.x),
        (this._cache.y = this.y),
    ...
    (e.Text.prototype.destroy = function () {
      this.group && this.group.remove(this),
    ...
    Object.defineProperty(e.Text.prototype, "angle", {
      get: function () {
        return e.Math.radToDeg(this.rotation);
      },
      set: function (a) {
        this.rotation = e.Math.degToRad(a);
      },
    }),
    Object.defineProperty(e.Text.prototype, "content", {
      get: function () {
        return this._text;
      },
      set: function (a) {
    ...
    (e.BitmapText = function (a, b, c, f, g) {
      (b = b || 0),
        (c = c || 0),
        (f = f || ""),
        (g = g || ""),
        ...
        (this.name = ""),
        (this.game = a),
        d.BitmapText.call(this, f, g),
        (this.type = e.BITMAPTEXT),
        (this.position.x = b),
        (this.position.y = c),
        (this.anchor = new e.Point()),
        (this.scale = new e.Point(1, 1)),
    ...
    (e.BitmapText.prototype = Object.create(d.BitmapText.prototype)),
    (e.BitmapText.prototype.constructor = e.BitmapText),
    (e.BitmapText.prototype.update = function () {
      this.exists &&
        ((this._cache.dirty = !1),
        (this._cache.x = this.x),
        (this._cache.y = this.y),
    ...
    (e.BitmapText.prototype.destroy = function () {
      this.group && this.group.remove(this),
        this.canvas.parentNode
          ? this.canvas.parentNode.removeChild(this.canvas)
          : ((this.canvas = null), (this.context = null)),
    ...
    Object.defineProperty(e.BitmapText.prototype, "angle", {
      get: function () {
        return e.Math.radToDeg(this.rotation);
      },
      set: function (a) {
    ...
    Object.defineProperty(e.BitmapText.prototype, "x", {
      get: function () {
    ...
    Object.defineProperty(e.BitmapText.prototype, "y", {
      get: function () {
    ...
    (e.Button = function (a, b, c, d, f, g, h, i, j) {
      (b = b || 0),
        (c = c || 0),
        (d = d || null),
        (f = f || null),
        (g = g || this),
        e.Sprite.call(this, a, b, c, d, i),
        (this.type = e.BUTTON),
        ...
        (this.onInputOver = new e.Signal()),
        (this.onInputOut = new e.Signal()),
        (this.onInputDown = new e.Signal()),
        (this.onInputUp = new e.Signal()),
        (this.freezeFrames = !1),
    ...
    (e.Button.prototype = Object.create(e.Sprite.prototype)),
    (e.Button.prototype = e.Utils.extend(
      !0,
      e.Button.prototype,
      e.Sprite.prototype,
      d.Sprite.prototype
    )),
    (e.Button.prototype.constructor = e.Button),
    (e.Button.prototype.setFrames = function (a, b, c) {
      null !== a &&
        ("string" == typeof a
        ...
        null !== b &&
          ("string" == typeof b
            ? ((this._onOutFrameName = b),
              ...
              0 == this.input.pointerOver() && (this.frameName = b))
            : ((this._onOutFrameID = b),
              (this._onUpFrameID = b),
              0 == this.input.pointerOver() && (this.frame = b))),
        null !== c &&
          ("string" == typeof c
            ? ((this._onDownFrameName = c),
              this.input.pointerOver() && (this.frameName = c))
            : ((this._onDownFrameID = c),
              this.input.pointerOver() && (this.frame = c)));
    }),
    (e.Button.prototype.setSounds = function (a, b, c, d, e, f, g, h) {
      this.setOverSound(a, b),
        this.setOutSound(e, f),
        this.setUpSound(g, h),
        this.setDownSound(c, d);
    }),
    (e.Button.prototype.setOverSound = function (a, b) {
      (this.onOverSound = null),
        (this.onOverSoundMarker = ""),
        a instanceof e.Sound && (this.onOverSound = a),
        "string" == typeof b && (this.onOverSoundMarker = b);
    }),
    (e.Button.prototype.setOutSound = function (a, b) {
      (this.onOutSound = null),
        (this.onOutSoundMarker = ""),
        a instanceof e.Sound && (this.onOutSound = a),
        "string" == typeof b && (this.onOutSoundMarker = b);
    }),
    (e.Button.prototype.setUpSound = function (a, b) {
      (this.onUpSound = null),
        (this.onUpSoundMarker = ""),
        a instanceof e.Sound && (this.onUpSound = a),
        "string" == typeof b && (this.onUpSoundMarker = b);
    }),
    (e.Button.prototype.setDownSound = function (a, b) {
      (this.onDownSound = null),
        (this.onDownSoundMarker = ""),
        a instanceof e.Sound && (this.onDownSound = a),
        "string" == typeof b && (this.onDownSoundMarker = b);
    }),
    (e.Button.prototype.onInputOverHandler = function (a) {
      0 == this.freezeFrames &&
    ...
    (e.Button.prototype.onInputOutHandler = function (a) {
      0 == this.freezeFrames &&
    ...
    (e.Button.prototype.onInputDownHandler = function (a) {
      0 == this.freezeFrames &&
    ...
    (e.Button.prototype.onInputUpHandler = function (a) {
      0 == this.freezeFrames &&
    ...
    (e.Graphics = function (a) {
      (this.game = a), d.Graphics.call(this), (this.type = e.GRAPHICS);
    }),
    (e.Graphics.prototype = Object.create(d.Graphics.prototype)),
    (e.Graphics.prototype.constructor = e.Graphics),
    (e.Graphics.prototype.destroy = function () {
      this.clear(), this.group && this.group.remove(this), (this.game = null);
    }),
    Object.defineProperty(e.Graphics.prototype, "angle", {
      get: function () {
        return e.Math.wrapAngle(e.Math.radToDeg(this.rotation));
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Graphics.prototype, "x", {
      get: function () {
        return this.position.x;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Graphics.prototype, "y", {
      get: function () {
        return this.position.y;
      },
      set: function (a) {
    ...
    (e.RenderTexture = function (a, b, c, f) {
      (this.game = a),
        (this.name = b),
        d.EventTarget.call(this),
        (this.width = c || 100),
        ...
        (this.indetityMatrix = d.mat3.create()),
        (this.frame = new d.Rectangle(0, 0, this.width, this.height)),
        (this.type = e.RENDERTEXTURE),
        d.gl ? this.initWebGL() : this.initCanvas();
    }),
    (e.RenderTexture.prototype = e.Utils.extend(!0, d.RenderTexture.prototype)),
    ...
    (e.Canvas = {
      ...
      getOffset: function (a, b) {
        ...
        var c = a.getBoundingClientRect(),
          d = a.clientTop || document.body.clientTop || 0,
        ...
        return (b.x = c.left + h - f), (b.y = c.top + g - d), b;
      },
          ...
          "" !== b
            ? document.getElementById(b)
              ? (document.getElementById(b).appendChild(a),
                c && (document.getElementById(b).style.overflow = "hidden"))
    ...
    (e.StageScaleMode = function (a, b, c) {
      (this._startHeight = 0),
        ...
        (this.game = a),
        (this.enterLandscape = new e.Signal()),
        (this.enterPortrait = new e.Signal()),
        (this.orientation = window.orientation
          ? window.orientation
          : window.outerWidth > window.outerHeight
          ? 90
          : 0),
        (this.scaleFactor = new e.Point(1, 1)),
        (this.aspectRatio = 0);
      var d = this;
      window.addEventListener(
        "orientationchange",
        function (a) {
          return d.checkOrientation(a);
        },
        !1
      ),
        window.addEventListener(
    ...
    (e.StageScaleMode.EXACT_FIT = 0),
    (e.StageScaleMode.NO_SCALE = 1),
    (e.StageScaleMode.SHOW_ALL = 2),
    (e.StageScaleMode.prototype = {
      startFullScreen: function (a) {
        if (!this.isFullScreen) {
          "undefined" != typeof a &&
            e.Canvas.setSmoothingEnabled(this.game.context, a);
      ...
      checkOrientation: function () {
        (this.orientation = window.orientation),
          ...
          this.game.stage.scaleMode !== e.StageScaleMode.NO_SCALE &&
            this.refresh();
      },
      ...
      refresh: function () {
        var a = this;
        0 == this.game.device.iPad &&
          0 == this.game.device.webApp &&
          0 == this.game.device.desktop &&
          (this.game.device.android && 0 == this.game.device.chrome
            ? window.scrollTo(0, 1)
            : window.scrollTo(0, 0)),
          null == this._check &&
      ...
      setScreenSize: function (a) {
        "undefined" == typeof a && (a = !1),
          ...
          (a ||
            ...
            1 == this.incorrectOrientation
              ? this.setMaximum()
              : this.game.stage.scaleMode == e.StageScaleMode.EXACT_FIT
              ? this.setExactFit()
              : this.game.stage.scaleMode == e.StageScaleMode.SHOW_ALL &&
                this.setShowAll(),
            this.setSize(),
        ...
        0 == this.incorrectOrientation &&
          ...
          this.pageAlignHorizontally &&
            (this.game.canvas.style.marginLeft =
              this.width < window.innerWidth && 0 == this.incorrectOrientation
                ? Math.round((window.innerWidth - this.width) / 2) + "px"
                : "0px"),
          this.pageAlignVertically &&
            (this.game.canvas.style.marginTop =
              this.height < window.innerHeight && 0 == this.incorrectOrientation
                ? Math.round((window.innerHeight - this.height) / 2) + "px"
                : "0px"),
          e.Canvas.getOffset(this.game.canvas, this.game.stage.offset),
          (this.aspectRatio = this.width / this.height),
          (this.scaleFactor.x = this.game.width / this.width),
          (this.scaleFactor.y = this.game.height / this.height);
      },
    ...
    Object.defineProperty(e.StageScaleMode.prototype, "isFullScreen", {
      get: function () {
        return (
    ...
    Object.defineProperty(e.StageScaleMode.prototype, "isPortrait", {
      get: function () {
        return 0 == this.orientation || 180 == this.orientation;
      },
    }),
    Object.defineProperty(e.StageScaleMode.prototype, "isLandscape", {
      get: function () {
    ...
    (e.Device.prototype = {
      ...
      _checkFeatures: function () {
        ...
        (this.file = !!(
          ...
          ("ontouchstart" in document.documentElement ||
            ...
            (this.touch = !0),
          window.navigator.msPointerEnabled && (this.mspointer = !0),
          (this.pointerLock =
      ...
      _checkBrowser: function () {
        ...
        /Arora/.test(a)
          ...
          ? (this.mobileSafari = !0)
          : /MSIE (\d+\.\d+);/.test(a)
          ? ((this.ie = !0), (this.ieVersion = parseInt(RegExp.$1)))
          : /Midori/.test(a)
          ? (this.midori = !0)
          : /Opera/.test(a)
          ? (this.opera = !0)
    ...
    (e.RequestAnimationFrame = function (a) {
      (this.game = a), (this._isSetTimeOut = !1), (this.isRunning = !1);
      for (
    ...
    (e.RequestAnimationFrame.prototype = {
      ...
      updateRAF: function (a) {
        this.game.update(a), window.requestAnimationFrame(this._onLoop);
      },
    ...
    (e.RandomDataGenerator = function (a) {
      "undefined" == typeof a && (a = []), this.sow(a);
    }),
    ...
    (e.Math = {
      ...
      distanceRounded: function (a, b, c, d) {
    ...
    (e.QuadTree = function (a, b, c, d, e, f, g, h) {
    ...
    (e.Circle.prototype = {
      ...
      distance: function (a, b) {
        return (
          "undefined" == typeof b && (b = !1),
          b
            ? e.Math.distanceRound(this.x, this.y, a.x, a.y)
            : e.Math.distance(this.x, this.y, a.x, a.y)
        );
      },
      clone: function (b) {
        return (
          "undefined" == typeof b && (b = new e.Circle()),
          b.setTo(a.x, a.y, a.diameter)
        );
      },
      contains: function (a, b) {
        return e.Circle.contains(this, a, b);
      },
      circumferencePoint: function (a, b, c) {
        return e.Circle.circumferencePoint(this, a, b, c);
      },
      offset: function (a, b) {
    ...
    Object.defineProperty(e.Circle.prototype, "diameter", {
      get: function () {
    ...
    (e.Circle.contains = function (a, b, c) {
    ...
    (e.Circle.equals = function (a, b) {
      return a.x == b.x && a.y == b.y && a.diameter == b.diameter;
    }),
    (e.Circle.intersects = function (a, b) {
      return e.Math.distance(a.x, a.y, b.x, b.y) <= a.radius + b.radius;
    }),
    (e.Circle.circumferencePoint = function (a, b, c, d) {
      return (
        "undefined" == typeof c && (c = !1),
        "undefined" == typeof d && (d = new e.Point()),
        c === !0 && (b = e.Math.radToDeg(b)),
        (d.x = a.x + a.radius * Math.cos(b)),
        (d.y = a.y + a.radius * Math.sin(b)),
        d
      );
    }),
    (e.Circle.intersectsRectangle = function (a, b) {
    ...
    (e.Point.prototype = {
      ...
      clampX: function (a, b) {
        return (this.x = e.Math.clamp(this.x, a, b)), this;
      },
      clampY: function (a, b) {
        return (this.y = e.Math.clamp(this.y, a, b)), this;
      },
      clamp: function (a, b) {
        return (
          (this.x = e.Math.clamp(this.x, a, b)),
          (this.y = e.Math.clamp(this.y, a, b)),
          this
        );
      },
      clone: function (a) {
        return (
          "undefined" == typeof a && (a = new e.Point()),
      ...
      distance: function (a, b) {
        return e.Point.distance(this, a, b);
      },
      equals: function (a) {
        return a.x == this.x && a.y == this.y;
      },
      rotate: function (a, b, c, d, f) {
        return e.Point.rotate(this, a, b, c, d, f);
      },
    ...
    (e.Point.add = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = new e.Point()),
        (c.x = a.x + b.x),
        (c.y = a.y + b.y),
        c
      );
    }),
    (e.Point.subtract = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = new e.Point()),
        (c.x = a.x - b.x),
        (c.y = a.y - b.y),
    ...
    (e.Point.multiply = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = new e.Point()),
        (c.x = a.x * b.x),
        (c.y = a.y * b.y),
    ...
    (e.Point.equals = function (a, b) {
      return a.x == b.x && a.y == b.y;
    }),
    (e.Point.distance = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = !1),
        c
          ? e.Math.distanceRound(a.x, a.y, b.x, b.y)
          : e.Math.distance(a.x, a.y, b.x, b.y)
      );
    }),
    (e.Point.rotate = function (a, b, c, d, f, g) {
      return (
        (f = f || !1),
        (g = g || null),
        f && (d = e.Math.radToDeg(d)),
        null === g &&
          (g = Math.sqrt((b - a.x) * (b - a.x) + (c - a.y) * (c - a.y))),
        a.setTo(b + g * Math.cos(d), c + g * Math.sin(d))
      );
    }),
    ...
    (e.Rectangle.prototype = {
      ...
      inflate: function (a, b) {
        return e.Rectangle.inflate(this, a, b);
      },
      size: function (a) {
        return e.Rectangle.size(this, a);
      },
      clone: function (a) {
        return e.Rectangle.clone(this, a);
      },
      contains: function (a, b) {
        return e.Rectangle.contains(this, a, b);
      },
      containsRect: function (a) {
        return e.Rectangle.containsRect(this, a);
      },
      equals: function (a) {
        return e.Rectangle.equals(this, a);
      },
      intersection: function (a) {
        return e.Rectangle.intersection(this, a, output);
      },
      intersects: function (a, b) {
        return e.Rectangle.intersects(this, a, b);
      },
      intersectsRaw: function (a, b, c, d, f) {
        return e.Rectangle.intersectsRaw(this, a, b, c, d, f);
      },
      union: function (a, b) {
        return e.Rectangle.union(this, a, b);
      },
      toString: function () {
        return (
          "[{Rectangle (x=" +
    ...
    (e.Rectangle.inflate = function (a, b, c) {
      return (a.x -= b), (a.width += 2 * b), (a.y -= c), (a.height += 2 * c), a;
    }),
    (e.Rectangle.inflatePoint = function (a, b) {
      return e.Rectangle.inflate(a, b.x, b.y);
    }),
    (e.Rectangle.size = function (a, b) {
      return (
        "undefined" == typeof b && (b = new e.Point()),
        b.setTo(a.width, a.height)
      );
    }),
    (e.Rectangle.clone = function (a, b) {
      return (
        "undefined" == typeof b && (b = new e.Rectangle()),
        b.setTo(a.x, a.y, a.width, a.height)
      );
    }),
    (e.Rectangle.contains = function (a, b, c) {
      return b >= a.x && b <= a.right && c >= a.y && c <= a.bottom;
    }),
    (e.Rectangle.containsRaw = function (a, b, c, d, e, f) {
      return e >= a && a + c >= e && f >= b && b + d >= f;
    }),
    (e.Rectangle.containsPoint = function (a, b) {
      return e.Rectangle.contains(a, b.x, b.y);
    }),
    (e.Rectangle.containsRect = function (a, b) {
    ...
    (e.Rectangle.equals = function (a, b) {
      return (
        a.x == b.x && a.y == b.y && a.width == b.width && a.height == b.height
      );
    }),
    (e.Rectangle.intersection = function (a, b, c) {
      return (
        (c = c || new e.Rectangle()),
        e.Rectangle.intersects(a, b) &&
    ...
    (e.Rectangle.intersects = function (a, b) {
      return a.x < b.right && b.x < a.right && a.y < b.bottom && b.y < a.bottom;
    }),
    (e.Rectangle.intersectsRaw = function (a, b, c, d, e, f) {
      return (
        "undefined" == typeof f && (f = 0),
        !(
          b > a.right + f ||
    ...
    (e.Rectangle.union = function (a, b, c) {
      return (
        "undefined" == typeof c && (c = new e.Rectangle()),
        c.setTo(
          Math.min(a.x, b.x),
          Math.min(a.y, b.y),
    ...
    (e.TweenManager.prototype = {
      ...
      create: function (a) {
        return new e.Tween(a, this.game);
      },
      remove: function (a) {
    ...
    (e.Tween = function (a, b) {
      (this._object = a),
        ...
        (this._interpolationFunction = e.Math.linearInterpolation),
        (this._chainedTweens = []),
    ...
    (e.AnimationManager.prototype = {
        ...
        return null == this._frameData
          ...
          : ((c = c || 60),
            ...
            null == this.sprite.events.onAnimationStart &&
              ((this.sprite.events.onAnimationStart = new e.Signal()),
              (this.sprite.events.onAnimationComplete = new e.Signal()),
              (this.sprite.events.onAnimationLoop = new e.Signal())),
            (this._outputFrames.length = 0),
            this._frameData.getFrameIndexes(b, g, this._outputFrames),
            (this._anims[a] = new e.Animation(
              this.game,
              this.sprite,
              a,
              this._frameData,
            ...
            this.sprite.setTexture(d.TextureCache[this.currentFrame.uuid]),
            this._anims[a]);
      },
      ...
      update: function () {
        return this.updateIfVisible && 0 == this.sprite.visible
          ? !1
          : this.currentAnim && 1 == this.currentAnim.update()
          ? ((this.currentFrame = this.currentAnim.currentFrame),
    ...
    Object.defineProperty(e.AnimationManager.prototype, "frameData", {
      get: function () {
    ...
    (e.Animation = function (a, b, c, d, e, f, g) {
      (this.game = a),
        (this._parent = b),
        (this._frameData = d),
        (this.name = c),
    ...
    (e.Animation.prototype = {
      play: function (a, b, c) {
        return (
          ...
          this._parent.setTexture(d.TextureCache[this.currentFrame.uuid]),
          this._parent.events &&
      ...
      update: function () {
        return this.isPaused
          ? !1
          : 1 == this.isPlaying && this.game.time.now >= this._timeNextFrame
          ? ((this._frameSkip = 1),
                ...
                ? ((this._frameIndex %= this._frames.length),
                  ...
                  this.currentFrame &&
                    this._parent.setTexture(
                      d.TextureCache[this.currentFrame.uuid]
                    ),
    ...
    Object.defineProperty(e.Animation.prototype, "paused", {
      get: function () {
        return this.isPaused;
      },
      set: function (a) {
    ...
    (e.Animation.generateFrameNames = function (a, b, c, d, f) {
      "undefined" == typeof d && (d = "");
      var g = [],
        h = "";
      if (c > b)
    ...
    (e.Frame = function (a, b, c, d, f, g, h) {
      (this.index = a),
        (this.x = b),
        (this.y = c),
        (this.width = d),
        ...
        (this.name = g),
        (this.uuid = h),
        (this.centerX = Math.floor(d / 2)),
        (this.centerY = Math.floor(f / 2)),
        (this.distance = e.Math.distance(0, 0, d, f)),
        (this.rotated = !1),
    ...
    Object.defineProperty(e.FrameData.prototype, "total", {
      get: function () {
        return this._frames.length;
      },
    }),
    (e.AnimationParser = {
      spriteSheet: function (a, b, c, f, g) {
        var h = a.cache.getImage(b);
        if (null == h) return null;
        var i = h.width,
          j = h.height;
        0 >= c && (c = Math.floor(-i / Math.min(-1, c))),
          0 >= f && (f = Math.floor(-j / Math.min(-1, f)));
        var k = Math.round(i / c),
          l = Math.round(j / f),
          m = k * l;
        if (
          (-1 !== g && (m = g), 0 == i || 0 == j || c > i || f > j || 0 === m)
        )
          return (
            console.warn(
        ...
        for (var n = new e.FrameData(), o = 0, p = 0, q = 0; m > q; q++) {
          var r = a.rnd.uuid();
          n.addFrame(new e.Frame(q, o, p, c, f, "", r)),
            (d.TextureCache[r] = new d.Texture(d.BaseTextureCache[b], {
              x: o,
              y: p,
              width: c,
              height: f,
      ...
      JSONData: function (a, b, c) {
        ...
        for (
          var f, g = new e.FrameData(), h = b.frames, i = 0;
          i < h.length;
          i++
        ) {
          var j = a.rnd.uuid();
          (f = g.addFrame(
            ...
            (d.TextureCache[j] = new d.Texture(d.BaseTextureCache[c], {
              x: h[i].frame.x,
              y: h[i].frame.y,
              width: h[i].frame.w,
              height: h[i].frame.h,
            ...
            h[i].trimmed &&
              ...
              (d.TextureCache[j].trimmed = !0),
              (d.TextureCache[j].trim.x = h[i].spriteSourceSize.x),
              (d.TextureCache[j].trim.y = h[i].spriteSourceSize.y));
        }
        return g;
      },
      JSONDataHash: function (a, b, c) {
        if (!b.frames)
          return (
            console.warn(
        ...
        for (var j in h) {
          ...
          (f = g.addFrame(
            ...
            (d.TextureCache[k] = new d.Texture(d.BaseTextureCache[c], {
              x: h[j].frame.x,
              y: h[j].frame.y,
              width: h[j].frame.w,
              height: h[j].frame.h,
            ...
            h[j].trimmed &&
              ...
              (d.TextureCache[k].trimmed = !0),
              (d.TextureCache[k].trim.x = h[j].spriteSourceSize.x),
              (d.TextureCache[k].trim.y = h[j].spriteSourceSize.y)),
            i++;
        }
        return g;
      },
      XMLData: function (a, b, c) {
        ...
        for (
          var f,
            ...
            p,
            q = new e.FrameData(),
            r = b.getElementsByTagName("SubTexture"),
            s = 0;
          s < r.length;
          s++
        )
          (g = a.rnd.uuid()),
            (h = r[s].attributes),
            (name = h.name.nodeValue),
            (i = parseInt(h.x.nodeValue)),
            (j = parseInt(h.y.nodeValue)),
            (k = parseInt(h.width.nodeValue)),
            (l = parseInt(h.height.nodeValue)),
            (m = null),
            (n = null),
            h.frameX &&
              ((m = Math.abs(parseInt(h.frameX.nodeValue))),
              (n = Math.abs(parseInt(h.frameY.nodeValue))),
              (o = parseInt(h.frameWidth.nodeValue)),
              (p = parseInt(h.frameHeight.nodeValue))),
            (f = q.addFrame(new e.Frame(s, i, j, k, l, name, g))),
            (d.TextureCache[g] = new d.Texture(d.BaseTextureCache[c], {
              x: i,
              y: j,
              width: k,
              height: l,
            ...
            (null !== m || null !== n) &&
              (f.setTrim(!0, k, l, m, n, o, p),
              (d.TextureCache[g].realSize = { x: m, y: n, w: o, h: p }),
              (d.TextureCache[g].trimmed = !0),
              (d.TextureCache[g].trim.x = m),
              (d.TextureCache[g].trim.y = n));
        return q;
      },
    }),
    (e.Cache = function (a) {
      (this.game = a),
        ...
        (this.onSoundUnlock = new e.Signal());
    }),
    (e.Cache.prototype = {
      ...
      addRenderTexture: function (a, b) {
        var c = new e.Frame(0, 0, 0, b.width, b.height, "", "");
        this._textures[a] = { texture: b, frame: c };
      },
      addSpriteSheet: function (a, b, c, f, g, h) {
        (this._images[a] = {
          url: b,
          data: c,
          spriteSheet: !0,
          ...
          (d.BaseTextureCache[a] = new d.BaseTexture(c)),
          (d.TextureCache[a] = new d.Texture(d.BaseTextureCache[a])),
          (this._images[a].frameData = e.AnimationParser.spriteSheet(
            this.game,
            a,
            f,
            g,
      ...
      addTileset: function (a, b, c, f, g, h, i, j) {
        (this._tilesets[a] = {
          url: b,
          data: c,
          tileWidth: f,
          ...
          (d.BaseTextureCache[a] = new d.BaseTexture(c)),
          (d.TextureCache[a] = new d.Texture(d.BaseTextureCache[a])),
          (this._tilesets[a].tileData = e.TilemapParser.tileset(
            this.game,
            a,
            f,
            g,
      ...
      addTilemap: function (a, b, c, d) {
        (this._tilemaps[a] = { url: b, data: c, format: d }),
          (this._tilemaps[a].layers = e.TilemapParser.parse(this.game, c, d));
      },
      addTextureAtlas: function (a, b, c, f, g) {
        (this._images[a] = { url: b, data: c, spriteSheet: !0 }),
          (d.BaseTextureCache[a] = new d.BaseTexture(c)),
          (d.TextureCache[a] = new d.Texture(d.BaseTextureCache[a])),
          g == e.Loader.TEXTURE_ATLAS_JSON_ARRAY
            ? (this._images[a].frameData = e.AnimationParser.JSONData(
                this.game,
                f,
                a
              ))
            : g == e.Loader.TEXTURE_ATLAS_JSON_HASH
            ? (this._images[a].frameData = e.AnimationParser.JSONDataHash(
                this.game,
                f,
                a
              ))
            : g == e.Loader.TEXTURE_ATLAS_XML_STARLING &&
              (this._images[a].frameData = e.AnimationParser.XMLData(
                this.game,
                f,
                a
              ));
      },
      addBitmapFont: function (a, b, c, f) {
        (this._images[a] = { url: b, data: c, spriteSheet: !0 }),
          (d.BaseTextureCache[a] = new d.BaseTexture(c)),
          (d.TextureCache[a] = new d.Texture(d.BaseTextureCache[a])),
          e.LoaderParser.bitmapFont(this.game, f, a);
      },
      addDefaultImage: function () {
        ...
        (a.src =
          ...
          (this._images.__default.frame = new e.Frame(0, 0, 0, 32, 32, "", "")),
          (d.BaseTextureCache.__default = new d.BaseTexture(a)),
          (d.TextureCache.__default = new d.Texture(
            d.BaseTextureCache.__default
          ));
      },
      ...
      addImage: function (a, b, c) {
        (this._images[a] = { url: b, data: c, spriteSheet: !1 }),
          (this._images[a].frame = new e.Frame(
            0,
            0,
            0,
            c.width,
      ...
      addSound: function (a, b, c, d, e) {
        (d = d || !0), (e = e || !1), this.game.sound.touchLocked;
        var f = !1;
        e && (f = !0),
          (this._sounds[a] = {
            url: b,
      ...
      getFrame: function (a) {
        return this._images[a] && 0 == this._images[a].spriteSheet
    ...
    (e.Loader = function (a) {
      (this.game = a),
        ...
        (this.crossOrigin = ""),
        (this.baseURL = ""),
        (this.onFileComplete = new e.Signal()),
        (this.onFileError = new e.Signal()),
        (this.onLoadStart = new e.Signal()),
        (this.onLoadComplete = new e.Signal());
    }),
    (e.Loader.TEXTURE_ATLAS_JSON_ARRAY = 0),
    (e.Loader.TEXTURE_ATLAS_JSON_HASH = 1),
    (e.Loader.TEXTURE_ATLAS_XML_STARLING = 2),
    (e.Loader.prototype = {
      setPreloadSprite: function (a, b) {
        (b = b || 0),
          ...
          (this.preloadSprite.crop =
            0 == b
              ? new e.Rectangle(0, 0, 1, a.height)
              : new e.Rectangle(0, 0, a.width, 1)),
          (a.crop = this.preloadSprite.crop),
          (a.cropEnabled = !0);
      },
      checkKeyExists: function (a) {
      ...
      addToFileList: function (a, b, c, d) {
        ...
        (this._fileList[b] = e), this._keys.push(b), this.queueSize++;
      },
      image: function (a, b, c) {
        return (
          "undefined" == typeof c && (c = !1),
          (c || 0 == this.checkKeyExists(a)) &&
      ...
      tilemap: function (a, b, c, d) {
        if (
          ("undefined" == typeof b && (b = null),
          "undefined" == typeof c && (c = null),
          "undefined" == typeof d && (d = e.Tilemap.CSV),
          null == b && null == c)
        )
          return (
            console.warn(
        ...
        if (this.checkKeyExists(a) === !1)
          if (b) this.addToFileList("tilemap", a, b, { format: d });
          else {
            switch (d) {
              case e.Tilemap.CSV:
                break;
            ...
            this.game.cache.addTilemap(a, null, c, d);
          }
        return this;
      },
      bitmapFont: function (a, b, c, d) {
        if (
          ...
          if (c) this.addToFileList("bitmapfont", a, b, { xmlURL: c });
      ...
      atlasJSONArray: function (a, b, c, d) {
        return this.atlas(a, b, c, d, e.Loader.TEXTURE_ATLAS_JSON_ARRAY);
      },
      atlasJSONHash: function (a, b, c, d) {
        return this.atlas(a, b, c, d, e.Loader.TEXTURE_ATLAS_JSON_HASH);
      },
      atlasXML: function (a, b, c, d) {
        return this.atlas(a, b, c, d, e.Loader.TEXTURE_ATLAS_XML_STARLING);
      },
      atlas: function (a, b, c, d, f) {
        if (
          ("undefined" == typeof c && (c = null),
          "undefined" == typeof d && (d = null),
          "undefined" == typeof f && (f = e.Loader.TEXTURE_ATLAS_JSON_ARRAY),
          this.checkKeyExists(a) === !1)
        )
          if (c)
      ...
      start: function () {
        this.isLoading ||
          ...
          this._keys.length > 0
            ? ((this._progressChunk = 100 / this._keys.length), this.loadFile())
            : ((this.progress = 100),
              (this.hasLoaded = !0),
              this.onLoadComplete.dispatch()));
      },
      loadFile: function () {
        var a = this._fileList[this._keys.shift()],
          b = this;
        switch (a.type) {
          case "image":
          case "spritesheet":
          ...
          case "tileset":
            (a.data = new Image()),
              ...
              (a.data.onload = function () {
                return b.fileComplete(a.key);
              }),
              (a.data.onerror = function () {
                return b.fileError(a.key);
              }),
                    ...
                    (this.game.sound.touchLocked
                      ...
                      : ((a.data = new Audio()),
                        ...
                        a.data.addEventListener(
                          "canplaythrough",
                          e.GAMES[this.game.id].load.fileComplete(a.key),
                          !1
                        ),
                        a.data.load()))
                : this.fileError(a.key);
            break;
          case "tilemap":
            this._xhr.open("GET", this.baseURL + a.url, !0),
              (this._xhr.responseType = "text"),
              a.format == e.Tilemap.TILED_JSON
                ? (this._xhr.onload = function () {
                    return b.jsonLoadComplete(a.key);
                  })
                : a.format == e.Tilemap.CSV &&
                  (this._xhr.onload = function () {
                    return b.csvLoadComplete(a.key);
                  }),
              (this._xhr.onerror = function () {
                return b.dataLoadError(a.key);
              }),
              this._xhr.send();
            break;
          case "text":
      ...
      fileComplete: function (a) {
        if (!this._fileList[a])
          return (
            console.warn("Phaser.Loader fileComplete invalid key " + a), void 0
          );
        this._fileList[a].loaded = !0;
          ...
          case "textureatlas":
            null == b.atlasURL
              ...
              : ((c = !1),
                ...
                (this._xhr.responseType = "text"),
                b.format == e.Loader.TEXTURE_ATLAS_JSON_ARRAY ||
                b.format == e.Loader.TEXTURE_ATLAS_JSON_HASH
                  ? (this._xhr.onload = function () {
                      return d.jsonLoadComplete(b.key);
                    })
                  : b.format == e.Loader.TEXTURE_ATLAS_XML_STARLING &&
                    (this._xhr.onload = function () {
                      return d.xmlLoadComplete(b.key);
                    }),
                (this._xhr.onerror = function () {
                  return d.dataLoadError(b.key);
                }),
                this._xhr.send());
            break;
          case "bitmapfont":
          ...
          case "audio":
            if (this.game.sound.usingWebAudio) {
              if (
                ...
                var f = this,
                  a = b.key;
                this.game.sound.context.decodeAudioData(b.data, function (b) {
              ...
              b.data.removeEventListener(
                "canplaythrough",
                e.GAMES[this.game.id].load.fileComplete
              ),
      ...
      jsonLoadComplete: function (a) {
        var b = JSON.parse(this._xhr.responseText),
          c = this._fileList[a];
        "tilemap" == c.type
          ? this.game.cache.addTilemap(c.key, c.url, b, c.format)
          : this.game.cache.addTextureAtlas(c.key, c.url, c.data, b, c.format),
          this.nextFile(a, !0);
      },
      ...
      dataLoadError: function (a) {
        var b = this._fileList[a];
        (b.error = !0),
          console.warn("Phaser.Loader dataLoadError: " + a),
          this.nextFile(a, !0);
      },
      xmlLoadComplete: function (a) {
        ...
        "bitmapfont" == f.type
          ...
          : "textureatlas" == f.type &&
            this.game.cache.addTextureAtlas(f.key, f.url, f.data, b, f.format),
          this.nextFile(a, !0);
      },
      nextFile: function (a, b) {
        (this.progress = Math.round(this.progress + this._progressChunk)),
          ...
          this.onFileComplete.dispatch(
            ...
            a,
            b,
            this.queueSize - this._keys.length,
            this.queueSize
          ),
          this._keys.length > 0
            ? this.loadFile()
    ...
    (e.LoaderParser = {
      bitmapFont: function (a, b, c) {
        ...
        for (var i = b.getElementsByTagName("char"), j = 0; j < i.length; j++) {
          ...
          (d.TextureCache[k] = new d.Texture(e, l)),
            (f.chars[k] = {
              xOffset: parseInt(
        ...
        d.BitmapText.fonts[f.font] = f;
      },
    }),
    (e.Sound = function (a, b, c, d) {
      (c = c || 1),
        "undefined" == typeof d && (d = !1),
        (this.game = a),
        (this.name = b),
        ...
        (this.onDecoded = new e.Signal()),
        (this.onPlay = new e.Signal()),
        (this.onPause = new e.Signal()),
        (this.onResume = new e.Signal()),
        (this.onLoop = new e.Signal()),
        (this.onStop = new e.Signal()),
        (this.onMute = new e.Signal()),
        (this.onMarkerComplete = new e.Signal());
    }),
    (e.Sound.prototype = {
      ...
      play: function (a, b, c, d, e) {
        if (
          ...
          1 != this.isPlaying || 0 != e || 0 != this.override)
        ) {
          if (
            (this.isPlaying &&
              this.override &&
            ...
            ? this.game.cache.isSoundDecoded(this.key)
              ...
              : ((this.pendingPlayback = !0),
                this.game.cache.getSound(this.key) &&
                  0 == this.game.cache.getSound(this.key).isDecoding &&
    ...
    Object.defineProperty(e.Sound.prototype, "isDecoding", {
      get: function () {
    ...
    (e.SoundManager = function (a) {
      (this.game = a),
        (this.onSoundDecode = new e.Signal()),
        (this._muted = !1),
    ...
    (e.SoundManager.prototype = {
      boot: function () {
        if (
          ...
          if (1 == window.PhaserGlobal.disableAudio)
            return (this.usingWebAudio = !1), (this.noAudio = !0), void 0;
          if (1 == window.PhaserGlobal.disableWebAudio)
            return (
      ...
      unlock: function () {
        if (0 != this.touchLocked)
          if (
            0 == this.game.device.webAudio ||
            (window.PhaserGlobal && 1 == window.PhaserGlobal.disableWebAudio)
          )
            (this.touchLocked = !1),
              (this._unlockSource = null),
      ...
      add: function (a, b, c) {
        (b = b || 1), "undefined" == typeof c && (c = !1);
        var d = new e.Sound(this.game, a, b, c);
        return this._sounds.push(d), d;
      },
    }),
    Object.defineProperty(e.SoundManager.prototype, "mute", {
      get: function () {
        return this._muted;
      },
      set: function (a) {
      ...
      dumpLinkedList: function (a) {
        ...
        do {
          var g = d.sprite.name || "*",
            ...
            j = "-",
            k = "-";
          d.next && (h = d.next.sprite.name),
            d.prev && (i = d.prev.sprite.name),
            d.first && (j = d.first.sprite.name),
            d.last && (k = d.last.sprite.name),
            "undefined" == typeof h && (h = "-"),
            "undefined" == typeof i && (i = "-"),
            "undefined" == typeof j && (j = "-"),
            "undefined" == typeof k && (k = "-");
    ...
    (e.Color = {
      ...
      getColorInfo: function (a) {
        var b = e.Color.getRGB(a),
          c = e.Color.RGBtoHSV(a),
          d = e.Color.RGBtoHexstring(a) + "\n";
        return (
          (d =
            d.concat(
              "Alpha: " +
      ...
      RGBtoHexstring: function (a) {
        ...
        return (
          "0x" +
          e.Color.colorToHexstring(b.alpha) +
          e.Color.colorToHexstring(b.red) +
          e.Color.colorToHexstring(b.green) +
          e.Color.colorToHexstring(b.blue)
        );
      },
      ...
      interpolateColor: function (a, b, c, d, f) {
        "undefined" == typeof f && (f = 255);
        var g = e.Color.getRGB(a),
          h = e.Color.getRGB(b),
          i = ((h.red - g.red) * d) / c + g.red,
          j = ((h.green - g.green) * d) / c + g.green,
          k = ((h.blue - g.blue) * d) / c + g.blue;
        return e.Color.getColor32(f, i, j, k);
      },
      interpolateColorWithRGB: function (a, b, c, d, f, g) {
        var h = e.Color.getRGB(a),
          i = ((b - h.red) * g) / f + h.red,
          j = ((c - h.green) * g) / f + h.green,
          k = ((d - h.blue) * g) / f + h.blue;
        return e.Color.getColor(i, j, k);
      },
      interpolateRGB: function (a, b, c, d, f, g, h, i) {
        var j = ((d - a) * i) / h + a,
          k = ((f - b) * i) / h + b,
          l = ((g - c) * i) / h + c;
        return e.Color.getColor(j, k, l);
      },
      getRandomColor: function (a, b, c) {
        if (
          ...
          return e.Color.getColor(255, 255, 255);
        if (a > b) return e.Color.getColor(255, 255, 255);
        var d = a + Math.round(Math.random() * (b - a)),
          f = a + Math.round(Math.random() * (b - a)),
          g = a + Math.round(Math.random() * (b - a));
        return e.Color.getColor32(c, d, f, g);
      },
      getRGB: function (a) {
        return {
          alpha: a >>> 24,
    ...
    (e.Physics = {}),
    (e.Physics.Arcade = function (a) {
      (this.game = a),
        (this.gravity = new e.Point()),
        (this.bounds = new e.Rectangle(0, 0, a.world.width, a.world.height)),
        (this.maxObjects = 10),
        (this.maxLevels = 4),
        (this.OVERLAP_BIAS = 4),
        (this.quadTree = new e.QuadTree(
          this,
        ...
        (this.quadTreeID = 0),
        (this._bounds1 = new e.Rectangle()),
        (this._bounds2 = new e.Rectangle()),
        (this._overlap = 0),
        (this._maxOverlap = 0),
        (this._velocity1 = 0),
        (this._velocity2 = 0),
    ...
    (e.Physics.Arcade.prototype = {
      ...
      overlap: function (a, b) {
        return a && b && a.exists && b.exists
          ? e.Rectangle.intersects(a.body, b.body)
          : !1;
      },
      collide: function (a, b, c, d, f) {
        return (
          ...
          a &&
            ...
            (a.type == e.SPRITE
              ? b.type == e.SPRITE
                ? this.collideSpriteVsSprite(a, b, c, d, f)
                : b.type == e.GROUP || b.type == e.EMITTER
                ? this.collideSpriteVsGroup(a, b, c, d, f)
                : b.type == e.TILEMAPLAYER &&
                  this.collideSpriteVsTilemapLayer(a, b, c, d, f)
              : a.type == e.GROUP
              ? b.type == e.SPRITE
                ? this.collideSpriteVsGroup(b, a, c, d, f)
                : b.type == e.GROUP || b.type == e.EMITTER
                ? this.collideGroupVsGroup(a, b, c, d, f)
                : b.type == e.TILEMAPLAYER &&
                  this.collideGroupVsTilemapLayer(a, b, c, d, f)
              : a.type == e.TILEMAPLAYER
              ? b.type == e.SPRITE
                ? this.collideSpriteVsTilemapLayer(b, a, c, d, f)
                : (b.type == e.GROUP || b.type == e.EMITTER) &&
                  this.collideGroupVsTilemapLayer(b, a, c, d, f)
              : a.type == e.EMITTER &&
                (b.type == e.SPRITE
                  ? this.collideSpriteVsGroup(b, a, c, d, f)
                  : b.type == e.GROUP || b.type == e.EMITTER
          ...
          : ((this._overlap = 0),
            ...
            0 == a.deltaX() && 0 == b.deltaX()
              ...
              ? ((this._overlap = a.x + a.width - b.x),
                ...
                0 == a.allowCollision.right ||
                0 == b.allowCollision.left
                  ? (this._overlap = 0)
                  : ((a.touching.right = !0), (b.touching.left = !0)))
              : a.deltaX() < b.deltaX() &&
                ((this._overlap = a.x - b.width - b.x),
                -this._overlap > this._maxOverlap ||
                0 == a.allowCollision.left ||
                0 == b.allowCollision.right
                  ? (this._overlap = 0)
          ...
          : ((this._overlap = 0),
            ...
            0 == a.deltaY() && 0 == b.deltaY()
              ...
              ? ((this._overlap = a.y + a.height - b.y),
                this._overlap > this._maxOverlap ||
                0 == a.allowCollision.down ||
                0 == b.allowCollision.up
                  ? (this._overlap = 0)
                  : ((a.touching.down = !0), (b.touching.up = !0)))
              : a.deltaY() < b.deltaY() &&
                ((this._overlap = a.y - b.height - b.y),
                -this._overlap > this._maxOverlap ||
                0 == a.allowCollision.up ||
                0 == b.allowCollision.down
                  ? (this._overlap = 0)
      ...
      separateTileX: function (a, b, c) {
        return a.immovable ||
          0 == a.deltaX() ||
          0 == e.Rectangle.intersects(a.hullX, b)
          ? !1
          : ((this._overlap = 0),
            a.deltaX() < 0
              ? ((this._overlap = b.right - a.hullX.x),
                0 == a.allowCollision.left || 0 == b.tile.collideRight
                  ? (this._overlap = 0)
                  : (a.touching.left = !0))
              : ((this._overlap = a.hullX.right - b.x),
                0 == a.allowCollision.right || 0 == b.tile.collideLeft
                  ? (this._overlap = 0)
                  : (a.touching.right = !0)),
            0 != this._overlap
              ? (c &&
      ...
      separateTileY: function (a, b, c) {
        return a.immovable ||
          0 == a.deltaY() ||
          0 == e.Rectangle.intersects(a.hullY, b)
          ? !1
          : ((this._overlap = 0),
            a.deltaY() < 0
              ? ((this._overlap = b.bottom - a.hullY.y),
                0 == a.allowCollision.up || 0 == b.tile.collideDown
                  ? (this._overlap = 0)
                  : (a.touching.up = !0))
              : ((this._overlap = a.hullY.bottom - b.y),
                0 == a.allowCollision.down || 0 == b.tile.collideUp
                  ? (this._overlap = 0)
                  : (a.touching.down = !0)),
            0 != this._overlap
              ? (c &&
    ...
    (e.Physics.Arcade.Body = function (a) {
      (this.sprite = a),
        (this.game = a.game),
        (this.offset = new e.Point()),
        (this.x = a.x),
        ...
        (this._sx = a.scale.x),
        (this._sy = a.scale.y),
        (this.velocity = new e.Point()),
        (this.acceleration = new e.Point()),
        (this.drag = new e.Point()),
        (this.gravity = new e.Point()),
        (this.bounce = new e.Point()),
        (this.maxVelocity = new e.Point(1e4, 1e4)),
        ...
        (this.overlapX = 0),
        (this.overlapY = 0),
        (this.hullX = new e.Rectangle()),
        (this.hullY = new e.Rectangle()),
        (this.embedded = !1),
        (this.collideWorldBounds = !1);
    }),
    (e.Physics.Arcade.Body.prototype = {
      ...
      postUpdate: function () {
        this.deltaX() < 0
          ? (this.facing = e.LEFT)
          : this.deltaX() > 0 && (this.facing = e.RIGHT),
          this.deltaY() < 0
            ? (this.facing = e.UP)
            : this.deltaY() > 0 && (this.facing = e.DOWN),
    ...
    Object.defineProperty(e.Physics.Arcade.Body.prototype, "bottom", {
      get: function () {
        return this.y + this.height;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Physics.Arcade.Body.prototype, "right", {
      get: function () {
        return this.x + this.width;
      },
      set: function (a) {
    ...
    (e.Particles = function () {
      (this.emitters = {}), (this.ID = 0);
    }),
    ...
    (e.Particles.Arcade = {}),
    (e.Particles.Arcade.Emitter = function (a, b, c, d) {
      (this.maxParticles = d || 50),
        e.Group.call(this, a),
        ...
        (this.width = 1),
        (this.height = 1),
        (this.minParticleSpeed = new e.Point(-100, -100)),
        (this.maxParticleSpeed = new e.Point(100, 100)),
    ...
    (e.Particles.Arcade.Emitter.prototype = Object.create(e.Group.prototype)),
    (e.Particles.Arcade.Emitter.prototype.constructor =
      e.Particles.Arcade.Emitter),
    (e.Particles.Arcade.Emitter.prototype.update = function () {
      if (this.on)
        if (this._explode) {
          this._counter = 0;
    ...
    (e.Particles.Arcade.Emitter.prototype.makeParticles = function (
      a,
      b,
      c,
      d,
      ...
      for (var g, h = 0, i = a, j = 0; c > h; )
        null == this.particleClass &&
          ...
          (g = new e.Sprite(this.game, 0, 0, i, j))),
          d > 0
    ...
    (e.Particles.Arcade.Emitter.prototype.kill = function () {
      (this.on = !1), (this.alive = !1), (this.exists = !1);
    }),
    (e.Particles.Arcade.Emitter.prototype.revive = function () {
      (this.alive = !0), (this.exists = !0);
    }),
    (e.Particles.Arcade.Emitter.prototype.start = function (a, b, c, d) {
      "boolean" != typeof a && (a = !0),
        (b = b || 0),
        (c = c || 250),
        (d = d || 0),
    ...
    (e.Particles.Arcade.Emitter.prototype.emitParticle = function () {
    ...
    (e.Particles.Arcade.Emitter.prototype.setSize = function (a, b) {
      (this.width = a), (this.height = b);
    }),
    (e.Particles.Arcade.Emitter.prototype.setXSpeed = function (a, b) {
      (a = a || 0),
        (b = b || 0),
        (this.minParticleSpeed.x = a),
        (this.maxParticleSpeed.x = b);
    }),
    (e.Particles.Arcade.Emitter.prototype.setYSpeed = function (a, b) {
      (a = a || 0),
        (b = b || 0),
        (this.minParticleSpeed.y = a),
        (this.maxParticleSpeed.y = b);
    }),
    (e.Particles.Arcade.Emitter.prototype.setRotation = function (a, b) {
      (a = a || 0),
        (b = b || 0),
        (this.minRotation = a),
        (this.maxRotation = b);
    }),
    (e.Particles.Arcade.Emitter.prototype.at = function (a) {
      (this.emitX = a.center.x), (this.emitY = a.center.y);
    }),
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "alpha", {
      get: function () {
        return this._container.alpha;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "visible", {
      get: function () {
        return this._container.visible;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "x", {
      get: function () {
        return this.emitX;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "y", {
      get: function () {
        return this.emitY;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "left", {
      get: function () {
        return Math.floor(this.x - this.width / 2);
      },
    }),
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "right", {
      get: function () {
        return Math.floor(this.x + this.width / 2);
      },
    }),
    ...
    Object.defineProperty(e.Particles.Arcade.Emitter.prototype, "bottom", {
      get: function () {
        return Math.floor(this.y + this.height / 2);
      },
    }),
    (e.Tile = function (a, b, c, d, e, f) {
      (this.tileset = a),
        (this.index = b),
        (this.width = e),
        (this.height = f),
    ...
    Object.defineProperty(e.Tile.prototype, "bottom", {
      get: function () {
        return this.y + this.height;
      },
    }),
    Object.defineProperty(e.Tile.prototype, "right", {
      get: function () {
        return this.x + this.width;
      },
    }),
    (e.Tilemap = function (a, b) {
      (this.game = a),
        this.layers,
        "string" == typeof b
          ? ((this.key = b),
    ...
    (e.Tilemap.CSV = 0),
    (e.Tilemap.TILED_JSON = 1),
    (e.Tilemap.prototype = {
      create: function (a, b, c) {
        for (var d = [], f = 0; c > f; f++) {
          d[f] = [];
          for (var g = 0; b > g; g++) d[f][g] = 0;
        }
      ...
      putTile: function (a, b, c, d) {
        "undefined" == typeof d && (d = this.currentLayer),
          b >= 0 &&
            b < this.layers[this.currentLayer].width &&
            c >= 0 &&
            c < this.layers[this.currentLayer].height &&
            (this.layers[this.currentLayer].data[c][b] = a),
          (this.dirty = !0);
      },
      getTile: function (a, b, c) {
        return (
          ...
          a >= 0 &&
          a < this.layers[this.currentLayer].width &&
          b >= 0 &&
          b < this.layers[this.currentLayer].height
            ? this.layers[this.currentLayer].data[b][a]
            : void 0
        );
      },
      ...
      putTileWorldXY: function (a, b, c, d, e) {
        (b = this.game.math.snapToFloor(b, d) / d),
    ...
    (e.TilemapLayer = function (a, b, c, f, g, h, i, j) {
      (this.game = a),
        (this.canvas = e.Canvas.create(f, g)),
        (this.context = this.canvas.getContext("2d")),
        (this.baseTexture = new d.BaseTexture(this.canvas)),
        (this.texture = new d.Texture(this.baseTexture)),
        (this.textureFrame = new e.Frame(
          0,
          0,
          0,
          f,
        ...
        e.Sprite.call(this, this.game, b, c, this.texture, this.textureFrame),
        (this.type = e.TILEMAPLAYER),
        ...
        (this._prevY = 0),
        (this.dirty = !0),
        (h instanceof e.Tileset || "string" == typeof h) &&
          this.updateTileset(h),
        i instanceof e.Tilemap && this.updateMapData(i, j);
    }),
    (e.TilemapLayer.prototype = Object.create(e.Sprite.prototype)),
    (e.TilemapLayer.prototype = e.Utils.extend(
      !0,
      e.TilemapLayer.prototype,
      e.Sprite.prototype,
      d.Sprite.prototype
    )),
    (e.TilemapLayer.prototype.constructor = e.TilemapLayer),
    (e.TilemapLayer.prototype.update = function () {
      (this.scrollX = this.game.camera.x),
        (this.scrollY = this.game.camera.y),
        this.render();
    }),
    (e.TilemapLayer.prototype.resizeWorld = function () {
      this.game.world.setBounds(0, 0, this.widthInPixels, this.heightInPixels);
    }),
    (e.TilemapLayer.prototype.updateTileset = function (a) {
      if (a instanceof e.Tileset) this.tileset = a;
      else {
    ...
    (e.TilemapLayer.prototype.updateMapData = function (a, b) {
      "undefined" == typeof b && (b = 0),
        a instanceof e.Tilemap &&
          ((this.tilemap = a),
    ...
    (e.TilemapLayer.prototype.getTileX = function (a) {
      var b = this.tileWidth * this.scale.x;
      return this.game.math.snapToFloor(a, b) / b;
    }),
    (e.TilemapLayer.prototype.getTileY = function (a) {
      var b = this.tileHeight * this.scale.y;
      return this.game.math.snapToFloor(a, b) / b;
    }),
    (e.TilemapLayer.prototype.getTileXY = function (a, b, c) {
      return (c.x = this.getTileX(a)), (c.y = this.getTileY(b)), c;
    }),
    (e.TilemapLayer.prototype.getTiles = function (a, b, c, d, e) {
    ...
    (e.TilemapLayer.prototype.updateMax = function () {
      (this._maxX =
    ...
    (e.TilemapLayer.prototype.render = function () {
      if (
        ...
        for (var a = this._startY; a < this._startY + this._maxY; a++) {
          ...
          for (var b = this._startX; b < this._startX + this._maxX; b++) {
            var c = this.tileset.tiles[this._column[b] - 1];
            c &&
        ...
        return (
          this.game.renderType == e.WEBGL &&
            d.texturesToUpdate.push(this.baseTexture),
          (this.dirty = !1),
    ...
    (e.TilemapLayer.prototype.deltaAbsX = function () {
      return this.deltaX() > 0 ? this.deltaX() : -this.deltaX();
    }),
    (e.TilemapLayer.prototype.deltaAbsY = function () {
      return this.deltaY() > 0 ? this.deltaY() : -this.deltaY();
    }),
    (e.TilemapLayer.prototype.deltaX = function () {
      return this._dx - this._prevX;
    }),
    (e.TilemapLayer.prototype.deltaY = function () {
      return this._dy - this._prevY;
    }),
    Object.defineProperty(e.TilemapLayer.prototype, "scrollX", {
      get: function () {
        return this._x;
      },
      set: function (a) {
    ...
    Object.defineProperty(e.TilemapLayer.prototype, "scrollY", {
      get: function () {
        return this._y;
      },
      set: function (a) {
    ...
    (e.TilemapParser = {
      tileset: function (a, b, c, d, f, g, h) {
        ...
        for (
          var o = g, p = g, q = new e.Tileset(i, b, c, d, g, h), r = 0;
          n > r;
          r++
        )
          q.addTile(new e.Tile(q, r, o, p, c, d)),
            (o += c + h),
            o === j && ((o = g), (p += d + h));
        return q;
      },
      parse: function (a, b, c) {
        return c === e.Tilemap.CSV
          ? this.parseCSV(b)
          : c === e.Tilemap.TILED_JSON
    ...
    (e.Tileset = function (a, b, c, d, e, f) {
      "undefined" == typeof e && (e = 0),
        "undefined" == typeof f && (f = 0),
        (this.key = b),
        (this.image = a),
    ...
    Object.defineProperty(e.Tileset.prototype, "total", {
      get: function () {
              ...
              f &&
                ...
                a.texture.trimmed
                  ? c.setTransform(
                      ...
                      b[1],
                      b[4],
                      b[2] + a.texture.trim.x,
                      b[5] + a.texture.trim.y
                    )
                  : c.setTransform(b[0], b[3], b[1], b[4], b[2], b[5]),
                c.drawImage(
                  a.texture.baseTexture.source,
